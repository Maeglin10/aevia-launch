...
const commun = (v) => ({
  form: {
    ...
    address: v.adresse,
    mainService: v.servicePrincipal,
    benefits: v.benefices,
    targetAudience: v.cible,
    priceRange: v.tarifs,
  },
  profil: {
...
export const CLIENTS = {
  "Santé": commun({
    ...
    servicePrincipal: "consultations de médecine générale et suivi de pathologies chroniques",
    benefices: ["créneau d'accès direct chaque matin", "trente minutes par consultation", "compte rendu au médecin traitant"],
    cible: "familles et patients suivis au long cours",
    tarifs: "25 € la consultation, conventionné secteur 1",
  ...
  "Services & Artisanat": commun({
    ...
    servicePrincipal: "réfection complète de toiture en zinc, ardoise et tuile plate",
    benefices: ["devis chiffré ligne par ligne", "garantie décennale remise à la réception", "chef de chantier joignable"],
    cible: "propriétaires de maisons anciennes du bassin annécien",
    tarifs: "à partir de 8 000 € la réfection",
  ...
  "Restauration": commun({
    ...
    servicePrincipal: "cuisine du marché, carte renouvelée chaque mercredi",
    benefices: ["six producteurs du bassin", "trente-deux couverts, une seule équipe", "aucun plat qui attend"],
    cible: "habitués du quartier et visiteurs de passage",
    tarifs: "menu 34 € le midi, 52 € le soir",
  ...
  "Droit & Finance": commun({
    ...
    servicePrincipal: "droit des affaires et contentieux commercial",
    benefices: ["premier rendez-vous de trente minutes offert", "une note écrite avant toute procédure", "vous êtes informé à chaque acte"],
    cible: "dirigeants de PME et professions libérales",
    tarifs: "280 € l'heure, forfait possible",
  ...
  "Sport & Coaching": commun({
    ...
    servicePrincipal: "préparation physique et remise en forme en petits groupes",
    benefices: ["six personnes maximum par séance", "un plan écrit sur douze semaines", "un test de progression chaque mois"],
    cible: "adultes qui reprennent après une longue coupure",
    tarifs: "89 € par mois, sans engagement",
  ...
  "Art & Création": commun({
    ...
    servicePrincipal: "pièces de grès tournées à la main, sur commande",
    benefices: ["tournées une par une", "grès cuit à 1 280 °C", "trois semaines de séchage à l'air"],
    cible: "particuliers et restaurants qui veulent une vaisselle unique",
    tarifs: "de 28 € le bol à 180 € le service",
  ...
  "Événementiel": commun({
    ...
    servicePrincipal: "organisation complète de mariage, du repérage au jour J",
    benefices: ["cinq lieux présélectionnés et visités avec vous", "prestataires consultés, comparés, contractualisés", "nous pilotons le jour J"],
    cible: "couples qui se marient en Provence",
    tarifs: "à partir de 4 500 € la coordination complète",
  ...
  "Beauté": commun({
    ...
    servicePrincipal: "coupe, couleur et soins du cuir chevelu",
    benefices: ["dix minutes de diagnostic avant tout geste", "retouche offerte sous quinze jours", "colorations sans ammoniaque"],
    cible: "femmes et hommes qui veulent un rendez-vous sans précipitation",
    tarifs: "de 38 € la coupe à 120 € la couleur",
  ...
  "Immobilier & Architecture": commun({
    ...
    servicePrincipal: "maîtrise d'œuvre complète, de la faisabilité à la réception",
    benefices: ["faisabilité rendue en trois semaines", "deux ou trois partis dessinés et chiffrés", "visites de chantier hebdomadaires"],
    cible: "particuliers qui construisent ou rénovent en Hauts-de-France",
    tarifs: "9 % du montant des travaux",
  ...
  "Hôtellerie & Voyage": commun({
    ...
    servicePrincipal: "cinq chambres d'hôtes et table d'hôtes sur demande",
    benefices: ["réservation en direct, sans commission", "petit-déjeuner maison", "visites de domaines organisées"],
    cible: "voyageurs qui veulent le Beaujolais autrement",
    tarifs: "de 95 € à 145 € la nuit, petit-déjeuner compris",
