 ...
 *   - Contact: valentinmilliand@aevia.services
 *   - TVA non applicable, art. 293 B du CGI
 *   - Hébergeur: Vercel Inc.
 *
 * ⚠️ The registered office street address is NEVER printed. It is "communiqué sur
 * demande à valentinmilliand@aevia.services" (label translated per locale).
 */

// ─── Constant identity facts (locale-independent) ────────────────────────────
const FACTS = {
  editeur: "Aevia WS",
  contactEmail: "valentinmilliand@aevia.services",
  director: "Valentin Milliand",
  siren: "852 546 225",
  rcs: "RCS Bourg-en-Bresse",
  hostName: "Vercel, Inc.",
  hostAddress: "440 N Barranca Avenue #4133, Covina, CA 91723, USA",
...
const T = {
  fr: {
    ...
    contact: "Contact",
    address: "Adresse",
    addressValue: "Adresse du siège social communiquée sur demande à valentinmilliand@aevia.services",
    vat: "TVA",
  ...
  en: {
    ...
    contact: "Contact",
    address: "Address",
    addressValue: "Registered office address provided on request at valentinmilliand@aevia.services",
    vat: "VAT",
  ...
  es: {
    ...
    contact: "Contacto",
    address: "Dirección",
    addressValue: "Dirección del domicilio social facilitada previa solicitud a valentinmilliand@aevia.services",
    vat: "IVA",
  ...
  de: {
    ...
    contact: "Kontakt",
    address: "Adresse",
    addressValue: "Anschrift des Firmensitzes auf Anfrage unter valentinmilliand@aevia.services",
    vat: "USt.",
  ...
  pt: {
    ...
    contact: "Contacto",
    address: "Morada",
    addressValue: "Morada da sede social fornecida mediante pedido para valentinmilliand@aevia.services",
    vat: "IVA",
