...
const HERO_T = {
  fr: {
    ...
    readySub: "Votre aperçu est prêt en 5 minutes, votre site publié dans la foulée.",
  ...
  en: {
    ...
    readySub: "Your preview is ready in 5 minutes, your site published right after.",
  ...
  es: {
    ...
    readySub: "Su vista previa está lista en 5 minutos, su sitio publicado justo después.",
  ...
  de: {
    ...
    readySub: "Ihre Vorschau ist in 5 Minuten fertig, Ihre Website direkt danach veröffentlicht.",
  ...
  pt: {
    ...
    readySub: "A sua pré-visualização fica pronta em 5 minutos, o site publicado logo a seguir.",
...
export default function HomePage() {
  return (
    <div id="main-content" className="font-aevia-body min-h-screen bg-[#09090b] text-white">
      ...
      {/* Section « Ce que disent nos clients » RETIRÉE : ses trois témoignages
          (Sophie L. restauratrice, Marc D. plombier, Elena V. coach) étaient
          inventés, avec villes et montants — de la preuve sociale fabriquée
          alors que les premiers clients arrivent tout juste. Elle reviendra
          avec de vrais retours, nommés et vérifiables. */}
      <FaqSection />
      <CtaSection />
      <LegalFooter />
    </div>
