    ...
    <div className="bg-[#faf9f6] text-[#2c3e2d] font-sans min-h-dvh selection:bg-[#d4e2d4] selection:text-[#2c3e2d] overflow-x-hidden">
          ...
          <Link href="#hero" className="flex items-center gap-3 group">
            {fd?.logoBase64 ? (
              ...
              <>
                ...
                <span className="text-xl font-light tracking-[0.2em] uppercase">{/* NOM_LOGO */ clientName({ formData: fd }) ?? (<>Oasis <span className="font-bold text-[#2c3e2d]">Wellness</span></>)}</span>
              </>
            )}
          </Link>
      ...
      <main>
        ...
        <section id="hero" className="relative h-[110vh] min-h-[640px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center">
            <Reveal>
              <div className="flex items-center justify-center gap-4 mb-8">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#2c3e2d]/50">{clientEyebrow(sessionData) ?? "Quiet the soul, heal the body"}</span>
                <div className="h-[1px] w-12 bg-[#2c3e2d]/30" />
              </div>
            </Reveal>
            ...
            <Reveal delay={0.4}>
              <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                <p className="text-lg text-[#2c3e2d]/60 font-light max-w-sm leading-relaxed">{clientHeroSubtitle(sessionData) ?? c?.heroSubline ?? <>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1, duration: 2 }} className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 text-[10px] font-bold uppercase tracking-[0.4em] text-[#2c3e2d]/30">
            Scroll to Breathe
              ...
              {[
                ...
                <Reveal key={p.name} delay={i * 0.1}>
                  <div className="p-10 bg-white rounded-3xl border border-[#2c3e2d]/5 text-center flex flex-col items-center">
                    ...
                    <div className="text-[10px] uppercase tracking-widest text-[#2c3e2d]/50 font-bold mb-4">{p.role}</div>
                ...
                <Reveal key={i} delay={i * 0.1}>
                  <div className="p-10 bg-[#faf9f6] rounded-3xl border border-[#2c3e2d]/5 flex flex-col justify-between h-full hover:border-[#2c3e2d]/25 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] uppercase tracking-widest text-[#2c3e2d]/50 font-bold mt-1">{t.plan}</div>
                    </div>
                  </div>
                </Reveal>
              ))}
            ...
            <Reveal delay={0.15}>
              {contactSubmitted ? (
                ...
                <form onSubmit={(e) => { e.preventDefault(); setContactSubmitted(true); }} className="space-y-4 max-w-md mx-auto text-left">
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-widest text-[#2c3e2d]/50 mb-2">Name</label>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-widest text-[#2c3e2d]/50 mb-2">Email</label>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-widest text-[#2c3e2d]/50 mb-2">Message</label>
