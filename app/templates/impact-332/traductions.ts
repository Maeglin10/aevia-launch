...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  fr: {
    "puis on pose.": "puis on pose.",
    "quand on force.": "quand on force.",
  },
  es: {
    ...
    "puis on pose.": "luego se coloca.",
    "quand on force.": "cuando se fuerza.",
  },
  de: {
    ...
    "puis on pose.": "dann legt man.",
    "quand on force.": "wenn man zwingt.",
  },
  pt: {
    ...
    "collection": "Coleção",
    "puis on pose.": "depois coloca-se.",
    "quand on force.": "quando se força.",
  },
};
