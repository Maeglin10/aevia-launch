        ...
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "1px solid rgba(253,249,238,0.08)", paddingTop: "2rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
            ...
            <div style={{ display: "flex", gap: "1.5rem" }}>
              <Link href="/templates/impact-40/legal?tab=mentions" style={{ textDecoration: "none", fontFamily: C.bodyFont, fontSize: "0.78rem", color: "rgba(253,249,238,0.35)" }}>
                Mentions Légales
              </Link>
              <Link href="/templates/impact-40/legal?tab=privacy" style={{ textDecoration: "none", fontFamily: C.bodyFont, fontSize: "0.78rem", color: "rgba(253,249,238,0.35)" }}>
                Confidentialité
              </Link>
            </div>
          </div>
