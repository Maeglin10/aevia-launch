...
let C: Record<string, string> = {
  primary: "var(--brand,#c9a84c)",
  primaryLight: "var(--brand-light,#dbbe6a)",
  primaryDark: "#a07e30",
  bg: "#141414",
  bgDeep: "#0d0d0d",
  bgCard: "#1e1e1e",
...
function PHOTO_LIVE() {
  return {
  hero: (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1505664194779-8beaceb93744?q=80&w=1600&auto=format&fit=crop"),
  ...
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1505664194779-8beaceb93744?q=80&w=1600&auto=format&fit=crop"),
        ...
        <div style={{
          ...
          <a href="#hero" style={{
            ...
            {fd?.logoBase64 ? (
              ...
              fd?.businessName ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Dubois & Partenaires"))
            )}
          </a>
        ...
        <div style={{
          ...
          <Reveal delay={0.55}>
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="#contact" style={{ textDecoration: 'none' }}>
                <Button filled>Consultation gratuite</Button>
              </a>
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "12 ans", "label": "d'Expertise"}, {"value": "150+", "label": "Startups"}, {"value": "98%", "label": "Taux de Réussite"}].map((stat, i) => (
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{fd?.businessName ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Dubois & Partenaires"))}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Due diligence, pactes d'actionnaires, levées de fonds Seed à Série B. Accompagnement des fondateurs de l'idée à l'exit.
            </p>
          </Reveal>
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <Reveal delay={0.15}>
              <div style={{
                ...
                {["Tous","Conseil","Contrats","Operations"].map((tab, i) => (
                  <button
                    key={i}
                ...
                <div style={{
                  ...
                  {formSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      ...
                      <Button type="submit" filled>Consultation gratuite</Button>
                    </form>
                  )}
                </div>
              </Reveal>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                Lun–Ven 9h–18h30 · Urgences sur demande
              </p>
            </div>
