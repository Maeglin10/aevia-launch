...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    "satisfaction clients": "Satisfaction des clients",
  },
  es: {
    ...
    "note clients": "Calificación de clientes",
    "satisfaction clients": "Satisfacción de los clientes",
  },
  de: {
  ...
  pt: {
    ...
    "collection": "Coleção",
    "note clients": "Avaliação de clientes",
    "satisfaction clients": "Satisfação dos clientes",
  },
};
