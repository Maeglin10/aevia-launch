    ...
    <div className="min-h-dvh bg-[#F6F3EE]" style={{ fontFamily: "'Jost', sans-serif" }}>
      ...
      <footer className="bg-[#EDE9E2] border-t border-[#D8D0C4] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-10">
          <div>
            ...
            <div className="space-y-1 text-xs text-[#6B5E52]">
              ...
              <div className="flex items-center gap-2"><Phone className="w-3 h-3" /> {fd?.phone ?? "+33 5 56 00 00 00"}</div>
        ...
        <div className="max-w-6xl mx-auto border-t border-[#D8D0C4] mt-10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#6B5E52]">
          <span>© 2026 Aura Wellness. Tous droits réservés.{/* VILLE_PIED */}{clientCity({ formData: fd }) ? ` · ${clientCity({ formData: fd })}` : ""}</span>
