      ...
      <footer className="bg-[#050505] pt-16 pb-8 px-6 border-t border-[var(--brand,#f97316)]/8">
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {[
            ...
            { t: "Contact", ls: [(clientPhone(sessionData) ?? fd?.phone ?? "06 23 72 22 65"), (fd?.email ?? "max@maxperf.fr"), (clientCity({ formData: fd }) ?? "Paris"), "Online worldwide", "1ère séance offerte"] },
          ].map((col, i) => (
            <div key={i}>
