    ...
    <div className="bg-[#0a0a0a] text-[#f8f5f0] overflow-x-hidden" style={{ fontFamily: "'Geist', 'Inter', system-ui, sans-serif" }}>
      ...
      <section id="hero" ref={heroRef} className="relative h-[100dvh] min-h-[640px] flex [align-items:safe_flex-end] overflow-hidden pt-24 sm:pt-0">
        <motion.div style={{ y: heroY }} className="absolute inset-0">
          <Image src={photo(0, (clientPhotos(sessionData)[0] || "https://images.pexels.com/photos/5646004/pexels-photo-5646004.jpeg?auto=compress&cs=tinysrgb&w=1600"))} alt="Coach sportif entraînement intense" fill className="object-cover object-center" priority style={{ filter: "brightness(0.3) saturate(0.8)" }} />
