...
function BOUTIQUE_PRODUCTS_LIVE() {
  ...
  },
  {
    ...
    emoji: "🎂",
    items: [
      { name: "Tarte Tatin", price: "4,80 €", desc: "Pommes caramélisées, pâte feuilletée inversée, crème fraîche artisanale.", img: clientPhotoAt(0, "https://images.pexels.com/photos/10885311/pexels-photo-10885311.jpeg?auto=compress&cs=tinysrgb&w=900") },
...
function TARTES_DATA_LIVE() {
  return [
  {
    ...
    img: clientPhotoAt(1, "https://images.pexels.com/photos/10885311/pexels-photo-10885311.jpeg?auto=compress&cs=tinysrgb&w=900"),
    badge: "Signature",
  },
  {
    ...
    img: clientPhotoAt(2, "https://images.pexels.com/photos/16526016/pexels-photo-16526016.jpeg?auto=compress&cs=tinysrgb&w=900"),
    badge: "Coup de cœur",
  },
  {
    ...
    img: clientPhotoAt(3, "https://images.pexels.com/photos/4748367/pexels-photo-4748367.jpeg?auto=compress&cs=tinysrgb&w=900"),
    badge: "Saison",
  },
  {
    ...
    img: clientPhotoAt(4, "https://images.pexels.com/photos/5252587/pexels-photo-5252587.jpeg?auto=compress&cs=tinysrgb&w=900"),
    badge: "Automne",
  },
];
}
...
export const TESTIMONIALS = [
  { name: "Isabelle T.", text: "La meilleure baguette tradition de " + clientCityOr("Paris") + ", sans hésitation. Le croissant est à se damner — feuilleté, aérien, pur beurre. J'y vais chaque samedi matin depuis 8 ans.", stars: 5 },
