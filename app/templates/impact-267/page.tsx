...
let C: Record<string, string> = {
  ...
  bgDarkAlt: '#060504',
  bgCard: '#ffffff',
  accent: 'var(--brand,#d45c20)',
  accentDark: 'var(--brand-light,#aa4818)',
  accentLight: '#f8dac8',
  white: '#ffffff',
  ink: '#0c0a08',
  textMuted: '#3c2c20',
...
function Hero() {
  ...
  return (
    <section ref={ref} id="hero" style={sec} className="hero-section">
      {/* Photo parallaxe */}
      <motion.div
        style={{
          position: 'absolute',
          ...
          >
            ...
            <div>
              ...
              >
                ...
                {/* LISTE_LIBELLES */ (clientList(sessionData, "reservation.liste1") ?? [
                  'Géométrique',
                  'Abstract',
                  'Portraiture',
                  'Végétal',
