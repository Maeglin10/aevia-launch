            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 bg-white/[0.01] border border-white/5 rounded-xl">
                ...
                <div>
                  ...
                  <a href="mailto:contact@exemple.fr" className="text-white hover:text-rose-500 transition-colors">contact@exemple.fr</a>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-white/[0.01] border border-white/5 rounded-xl">
              ...
              {!formSubmitted ? (
                ...
                <div className="text-center py-12 space-y-6">
                  ...
                  <p className="text-xs text-white/40 max-w-sm mx-auto leading-relaxed italic">
                    Your transmission has been securely routed to contact@exemple.fr. Our communications department will review it.
                  </p>
                </div>
              )}
            </Reveal>
