...
export default function PulseAppPage() {
  ...
  return (
    <div className="min-h-dvh bg-[#F8F7FF] text-[#0F0B2D]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#4B4570]">
            {[{ l: "Fonctionnalités", h: "#fonctionnalites" }, { l: "Tarifs", h: "#tarifs" }, { l: "Blog", h: "#blog" }, { l: "Docs", h: "#docs" }].map(({ l, h }) => (
              <Link key={l} href={h} className="hover:text-[var(--brand,#6366F1)] transition-colors duration-200">{l}</Link>
            ))}
          ...
          <div>
            ...
            <Reveal delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                <Link href="#fonctionnalites" className="flex items-center justify-center gap-2 px-7 py-4 bg-white text-[#0F0B2D] font-semibold rounded-xl border border-[#E8E5FF] hover:border-[var(--brand,#6366F1)] transition-colors cursor-pointer">
      ...
      <section id="about" className="py-20 bg-[var(--brand,#6366F1)] text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {(clientStats(sessionData)?.map((s: any) => [s.value, s.label]) ?? [["2 400+", "Équipes actives"], ["99.97%", "Uptime garanti"], ["4.9/5", "Note App Store"], ["2h/jour", "Temps économisé"]]).map(([val, label]) => (
              <Reveal key={label}>
      ...
      <section id="docs" className="py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="mb-14">
            <Reveal>
      ...
      {/* Blog */}
      <section id="blog" className="py-28 bg-[#faf9ff]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="mb-14">
            <Reveal>
