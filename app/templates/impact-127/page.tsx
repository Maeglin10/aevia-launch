      ...
      <main>
        ...
        <section id="hero" className="relative h-[110vh] min-h-[640px] flex items-center overflow-hidden">
          <motion.div style={{ y: heroY }} className="absolute inset-0">
            <Image src={photo(4, "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?auto=format&fit=crop&q=80&w=2400")} alt="Concert" fill className="object-cover opacity-50" priority />
          ...
          <motion.div style={{ opacity: heroOpacity }} className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-12 w-full">
            <Reveal delay={0.1} y={70}>
              <h1 className="text-7xl md:text-[8rem] lg:text-[11rem] font-black tracking-tighter leading-[0.8] mb-10 uppercase">{<>{clientHeroLine(sessionData, 0, 3, 6) ?? "Sentez"}<br/>{clientHeroLine(sessionData, 1, 3, 6) ?? "le"}{" "}{/* Le rose d'aplat ne tient que 3,9 sur la photo sombre du héros ; la
                  variante claire de la marque y tient 5,1. */}<span className="text-[var(--brand-light,#f472b6)]">{clientHeroLine(sessionData, 2, 3, 6) ?? "pouls."}</span>
              </>}</h1>
            </Reveal>
            <Reveal delay={0.25}>
        ...
        <section id="artists" className="py-32 bg-[#0c091a] border-t border-white/5">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { name: "Nova Collective", genre: "Electronic", origin: "Berlin", img: photo(5, "https://images.unsplash.com/photo-1493676304819-0d7a8d026dcf?w=600&q=80"), events: 3, followers: "182K" },
                { name: "The Archivists", genre: "Orchestral", origin: "London", img: photo(6, "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&q=80"), events: 2, followers: "94K" },
                { name: "Drift Engine", genre: "Techno", origin: "London", img: photo(7, "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=600&q=80"), events: 4, followers: "312K" },
                { name: "Halcyon Drift", genre: "Indie", origin: "Manchester", img: photo(8, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80"), events: 2, followers: "280K" },
              ].map((artist, i) => (
        ...
        <section id="accessibility" className="py-24 bg-[#0c091a] border-t border-white/5">
          <div className="max-w-[900px] mx-auto px-6 md:px-12">
            <Reveal>
              <h2 className="text-2xl md:text-3xl font-black tracking-tighter uppercase mb-6">{/* TEXTE_SECTION */ clientText(sessionData, "accessibility.titre") ?? (<>Accessibilité</>)}</h2>
        ...
        <section id="contact" className="relative h-[70vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <Image src={photo(9, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&q=80&w=2400")} alt="CTA" fill className="object-cover" />
