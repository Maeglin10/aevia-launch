...
export default function Page() {
  return (
    <div className="bg-[#08050a] min-h-dvh text-white/85 font-sans selection:bg-white/10">
      <header className="fixed top-0 left-0 right-0 z-50 px-8 py-6 bg-black/40 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <span className="text-sm font-semibold uppercase tracking-widest">PULSE</span>
        </div>
      </header>
