        ...
        >
          ...
          <div style={{ color: "rgba(240,236,224,0.7)", fontSize: 16, lineHeight: 1.8 }}>
            <p style={{ marginBottom: 24 }}>
              ...
              passées sur le site de la Maison Élara ou en boutique.
            </p>
            <p>
              Toute création sur mesure nécessite un acompte de 50% à la commande. Nos bijoux 
              sont garantis à vie contre tout vice de fabrication.
            </p>
          </div>
        </motion.div>
      </div>
