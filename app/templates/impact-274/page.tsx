...
function PHOTO_LIVE() {
  ...
  team:
    (clientPhotos(sessionData)[4] || 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?q=80&w=1600&auto=format&fit=crop'),
} as const;
}
...
function ScrollCrossfade() {
  ...
  return (
    <section
      style={{ height: '100dvh', overflow: 'hidden', position: 'relative', background: C.plumDeep }}
    >
      <div
        style={{
          position: 'relative',
    ...
    <section style={sec} id="blog">
      <div style={{ maxWidth: 1240, margin: '0 auto 68px', textAlign: 'center' }}>
        ...
        <Reveal delay={0.1}>
          ...
          >{/* TEXTE_SECTION */ clientText(sessionData, "blog.titre") ?? (<>
            Articles de{' '}
            <span style={{ fontStyle: 'italic', color: C.sage }}>
              notre équipe
            </span>
