        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }} className="grid-cols-1 md:grid-cols-2">
          ...
          <Reveal delay={0.2}>
            <div style={{ borderRadius: 16, overflow: "hidden", aspectRatio: "4/5" }}>
              <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&q=80" alt="Pratique yoga Lumière Studio" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </Reveal>
        </div>
      </section>
