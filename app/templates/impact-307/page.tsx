...
const SANS = "'Lato', sans-serif" as const;

const EASE: [number, number, number, number] = [0.16, 1, 0.3, 1];

function PHOTO_LIVE() {
  return {
  hero: (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=1600&auto=format&fit=crop"),
  about: (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=1600&auto=format&fit=crop"),
  special: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?q=80&w=1600&auto=format&fit=crop"),
  gallery1: (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1532712938310-34cb3982ef74?q=80&w=800&auto=format&fit=crop"),
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1527529482837-4698179dc6ce?q=80&w=800&auto=format&fit=crop"),
  gallery3: (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=800&auto=format&fit=crop"),
  gallery4: (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=800&auto=format&fit=crop")
} as const;
}
...
export default function Page() {
  ...
  const review0 = clientReviews(sessionData)?.[0];
return (
    <div style={{
      background: C.bg,
      color: C.text,
        ...
        <div style={{
          ...
          <div style={{ gap: 28, alignItems: 'center' }} className="hidden md:flex">
            ...
            <a href="#contact" style={{ textDecoration: 'none' }}>
              <button style={{
                /* Blanc sur cette teinte claire : sous le seuil. Fond assombri de 20 %. */
        ...
        <div style={{
          ...
          <Reveal delay={0.55}>
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="#contact" style={{ textDecoration: 'none' }}>
                <Button filled>Réservez une consultation</Button>
              </a>
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "10 ans", "label": "d'Expérience"}, {"value": "150+", "label": "Mariages Célébrés"}, {"value": "100%", "label": "Zen le Jour J"}].map((stat, i) => (
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{clientName(sessionData) ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Lumière & Vœux Lyon"))}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Rédaction et animation de votre cérémonie personnalisée. Vœux sur mesure, rituels symboliques, coordination avec le lieu.
            </p>
          </Reveal>
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <Reveal delay={0.15}>
              <div style={{
                ...
                {["Tous","Organisation","Decoration","Coordination"].map((tab, i) => (
                  <button
                    key={i}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? fd?.phone ?? "+33577307474").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientPhone(sessionData) ?? fd?.phone ?? "+33 (0)5 00 00 00 00"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 15, color: C.text, fontWeight: 700 }}>{fd?.city ?? "Lyon"}</div>
                    </div>
                  </div>
                </div>
              </Reveal>
                ...
                <div style={{
                  ...
                  {formSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      ...
                      <Button type="submit" filled>Réservez une consultation</Button>
                    </form>
                  )}
                </div>
              </Reveal>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                Lun–Ven 10h–19h · Sam sur rendez-vous
              </p>
            </div>
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6, fontSize: 12 }}>
                ...
                Responsable de publication: {clientName(sessionData) ?? "Lumière & Vœux Lyon"}<br />
