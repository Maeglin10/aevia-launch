      ...
      <section id="realisations" className="py-20 bg-white">
        <div className="max-w-[1300px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 h-[65vh] min-h-[420px]">
            <div className="col-span-2 relative overflow-hidden rounded-xl"><ParallaxImg src={photo(1, (clientPhotos(sessionData)[1] || "https://images.pexels.com/photos/38037229/pexels-photo-38037229.jpeg?auto=compress&cs=tinysrgb&w=1600"))} alt="Jardin créé" /></div>
