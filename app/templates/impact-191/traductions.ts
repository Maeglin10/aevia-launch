...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    "ce qu'on sait faire": "Ce que nous savons faire",
    "comment on": "Comment nous procédons",
  },
  es: {
    ...
    "avis clients": "Opiniones de los clientes",
    "ce qu'on sait faire": "Lo que sabemos hacer",
    "comment on": "Cómo lo hacemos",
  },
  de: {
    ...
    "ce qu'on sait faire": "Was wir können",
    "comment on": "Wie wir es machen",
  },
  pt: {
    ...
    "ce qu'on sait faire": "O que sabemos fazer",
    "comment on": "Como o fazemos",
  },
};
