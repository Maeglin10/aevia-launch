...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  fr: {
    "repartez avec un plan.": "partez avec un plan.",
  },
  es: {
    ...
    "repartez avec un plan.": "salga con un plan.",
  },
  de: {
    ...
    "repartez avec un plan.": "gehen Sie mit einem Plan.",
  },
  pt: {
    ...
    "collection": "Coleção",
    "repartez avec un plan.": "saia com um plano.",
  },
};
