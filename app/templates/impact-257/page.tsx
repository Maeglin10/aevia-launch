...
function PillarSequence() {
  ...
  const labelY = useTransform(scrollYProgress, [0, 1], [0, 0]);
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  required
                >
                  <option value="" style={{ color: '#111', background: '#1a2a18' }}>
                    Choisir un motif…
                  </option>
                  <option value="Consultation générale" style={{ color: '#111', background: '#1a2a18' }}>
                    Consultation générale
                  </option>
                  <option value="Médecine fonctionnelle" style={{ color: '#111', background: '#1a2a18' }}>
                    Médecine fonctionnelle
                  </option>
                  <option value="Bilan de santé" style={{ color: '#111', background: '#1a2a18' }}>
                    Bilan de santé
                  </option>
                  <option value="Maladies chroniques" style={{ color: '#111', background: '#1a2a18' }}>
                    Maladies chroniques
                  </option>
                  <option value="Micronutrition" style={{ color: '#111', background: '#1a2a18' }}>
                    Micronutrition
                  </option>
                  <option value="Autre" style={{ color: '#111', background: '#1a2a18' }}>
                    Autre
                  </option>
                </select>
              </div>
