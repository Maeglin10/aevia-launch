  ...
  return (
    <nav style={bar}>
      <div style={brand}>
        ...
        <div>
          Schreiber & Associés
          <span style={brandSub}>Expert-comptable · Strasbourg</span>
        </div>
      </div>
...
function ScrollCrossfade() {
  ...
  return (
    <section
      ref={ref}
      style={{ height: '320vh', position: 'relative', background: C.blueDeep }}
    >
      <div
        style={{
          position: 'sticky',
    ...
    <footer style={foot}>
      ...
      >
        ...
        <div>
          ...
          >
            <Scale size={22} color="rgba(255,255,255,0.75)" strokeWidth={1.6} />
            Schreiber & Associés
          </div>
          <div
            style={{
