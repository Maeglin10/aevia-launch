...
return (
    <div ref={pageRef} className="text-[#e8e8ff]">
            ...
            <Reveal delay={0.3}>
              <div style={{ display: "flex", gap: 16 }}>
                <Link
                  ...
                  style={{
                    background: "linear-gradient(135deg, var(--brand-light,#7c3aed), #5b21b6)",
                    color: "#fff",
                    textDecoration: "none",
                    fontWeight: 600,
                    fontSize: 14,
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(300px, 100%), 1fr))", gap: 24 }}>
            {PRESTATIONS_ANON.map((plan, i) => (
              <Reveal key={plan.name} delay={i * 0.08}>
                <div
                  style={{
                    background: plan.highlight ? "linear-gradient(135deg, var(--brand-light,#7c3aed), #5b21b6)" : "rgba(124,58,237,0.04)",
      ...
      <footer style={{ padding: "40px 24px", textAlign: "center", fontSize: 13, letterSpacing: "0.08em", opacity: 0.9, textShadow: "0 0 2px rgba(0,0,0,0.55), 0 0 10px rgba(255,255,255,0.35)" }}>
        {clientName(sessionData) ?? "Studio Volume"}
