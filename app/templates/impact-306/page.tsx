...
let C: Record<string, string> = {
  primary: "var(--brand,#8b6914)",
  primaryLight: "var(--brand-light,#a88030)",
  primaryDark: "#6a5010",
  bg: "#fffdf5",
  bgDeep: "#fff8e6",
  bgCard: "#ffffff",
...
const SERIF = "'Libre Baskerville', serif" as const;
...
function PHOTO_LIVE() {
  return {
  hero: (clientPhotos(sessionData)[0] || "https://images.pexels.com/photos/8633662/pexels-photo-8633662.jpeg?auto=compress&cs=tinysrgb&w=1600"),
  about: (clientPhotos(sessionData)[1] || "https://images.pexels.com/photos/8633662/pexels-photo-8633662.jpeg?auto=compress&cs=tinysrgb&w=1600"),
  special: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?q=80&w=1600&auto=format&fit=crop"),
  gallery1: (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1555507036-ab1f4038808a?q=80&w=800&auto=format&fit=crop"),
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1549931319-a545dcf3bc73?q=80&w=800&auto=format&fit=crop"),
  gallery3: (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1587314168485-3236d6710814?q=80&w=800&auto=format&fit=crop"),
  gallery4: (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1517433456452-f9633a875f6f?q=80&w=800&auto=format&fit=crop")
} as const;
}
...
export default function Page() {
  ...
  const [formData, setFormData] = useState({ name: '', email: '', phone: '', message: '', item: '', neededFor: '', quantity: '1' });
  const selectItemForOrder = (name: string) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (formData.name && formData.email && formData.phone && formData.item && formData.neededFor) {
      setFormLoading(true);
      setTimeout(() => {
      ...
      >
        ...
        <div style={{
          ...
          <Reveal delay={0.25}>
            ...
            }}>{<>{clientHeroLine(sessionData, 0, 2, 14) ?? "Pain Artisanal"}<br />{clientHeroLine(sessionData, 1, 2, 14) ?? "& Pâtisserie"}</>}</h1>
          </Reveal>
          ...
          <Reveal delay={0.55}>
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="#contact" style={{ textDecoration: 'none' }}>
                <Button filled>Commander un gâteau</Button>
              </a>
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "8 ans", "label": "Levain Naturel"}, {"value": "100%", "label": "Farines Bio"}, {"value": "AOP", "label": "Beurre Charentes"}].map((stat, i) => (
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Formule brunch 10h–14h : pain, viennoiseries, œufs brouillés, fromages locaux, jus frais. Sur réservation dès le jeudi.
            </p>
          </Reveal>
      ...
      <section id="menu" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <Reveal>
              <Eyebrow align="center">La Restauration</Eyebrow>
              <h2 style={{
                fontFamily: SERIF,
                fontSize: 'clamp(28px, 4vw, 44px)',
                color: C.primary,
              ...
              <Reveal key={i} delay={i * 0.05}>
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 10, flexShrink: 0 }}>
                    ...
                    <button
                      type="button"
                      onClick={() => selectItemForOrder(item.name)}
                      ...
                      style={{
                        ...
                        background: formData.item === item.name ? C.primary : 'transparent',
                        color: formData.item === item.name ? C.white : C.primary,
                        fontFamily: SANS,
                        fontSize: 13,
                        fontWeight: 700,
                        cursor: 'pointer',
                    ...
                    >
                      {formData.item === item.name ? 'Sélectionné ✓' : 'Commander'}
                    </button>
                  </div>
                </div>
              </Reveal>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? fd?.phone ?? "+33576237163").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientPhone(sessionData) ?? fd?.phone ?? "+33 (0)5 00 00 00 00"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientEmail(sessionData) ?? fd?.email ?? "contact@lamietteheureuse.com"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 15, color: C.text, fontWeight: 700 }}>{fd?.city ?? "Montpellier"}</div>
                    </div>
                  </div>
                </div>
              </Reveal>
                  ...
                  {formSubmitted ? (
                    ...
                    >
                      ...
                      <p style={{ fontSize: 14, color: C.textMuted, lineHeight: 1.6 }}>
                        Merci {formData.name}, nous avons bien reçu votre commande de {formData.quantity} × {formData.item || 'votre création'} pour le {formData.neededFor}. Nous vous recontactons rapidement au {formData.phone} pour confirmer.
                      </p>
                    </motion.div>
                  ) : (
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      <div>
                        <label htmlFor="cake-item" style={{ display: 'block', fontSize: 11, letterSpacing: '0.05em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 8, fontWeight: 600 }}>Quel gâteau/produit ?</label>
                        <select
                          id="cake-item"
                          required
                          value={formData.item}
                      ...
                      <div style={{ display: 'flex', gap: 16 }}>
                        <div style={{ flex: 1 }}>
                          <label htmlFor="cake-date" style={{ display: 'block', fontSize: 11, letterSpacing: '0.05em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 8, fontWeight: 600 }}>Date souhaitée</label>
                          <input
                            id="cake-date"
                            type="date"
                            required
                        ...
                        <div style={{ width: 100 }}>
                          <label htmlFor="cake-qty" style={{ display: 'block', fontSize: 11, letterSpacing: '0.05em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 8, fontWeight: 600 }}>Quantité</label>
                          <input
                            id="cake-qty"
                            type="number"
                            min={1}
                      ...
                      <div>
                        <label htmlFor="cake-name" style={{ display: 'block', fontSize: 11, letterSpacing: '0.05em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 8, fontWeight: 600 }}>Nom Complet</label>
                        <input
                          id="cake-name"
                          type="text"
                          required
                      ...
                      <div>
                        <label htmlFor="cake-email" style={{ display: 'block', fontSize: 11, letterSpacing: '0.05em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 8, fontWeight: 600 }}>Adresse E-mail</label>
                        <input
                          id="cake-email"
                          type="email"
                          required
                      ...
                      <div>
                        <label htmlFor="cake-phone" style={{ display: 'block', fontSize: 11, letterSpacing: '0.05em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 8, fontWeight: 600 }}>Téléphone</label>
                        <input
                          id="cake-phone"
                          type="tel"
                          required
                      ...
                      <div>
                        <label htmlFor="cake-message" style={{ display: 'block', fontSize: 11, letterSpacing: '0.05em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 8, fontWeight: 600 }}>Précisions (message personnalisé, allergies…)</label>
                        <textarea
                          id="cake-message"
                          rows={3}
                      ...
                      <Button type="submit" filled disabled={formLoading}>
                        {formLoading ? 'Envoi en cours…' : 'Commander un gâteau'}
                      </Button>
                    </form>
                  )}
                </div>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            © {new Date().getFullYear()} {clientName(sessionData) ?? "La Miette Heureuse."} Tous droits réservés.{/* VILLE_PIED */}{clientCity(sessionData) ? ` · ${clientCity(sessionData)}` : ""}
          </div>
        </div>
      </footer>
