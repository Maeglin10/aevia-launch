...
let C: Record<string, string> = {
  ...
  bgDarkAlt: '#0a0906',
  bgCard: '#ffffff',
  accent: 'var(--brand,#8c7248)',
  accentDark: 'var(--brand-light,#6e5838)',
  accentLight: '#e8dcc8',
  white: '#ffffff',
  ink: '#12100c',
  textMuted: '#403828',
    ...
    <>
      ...
      <div className="ms-navcta">
        ...
        @media (max-width: 860px) {
          ...
          .ms-burger { display: flex !important; flex-direction: column; }
      ...
      <div
        style={{
          ...
          background:
            ...
            'linear-gradient(to bottom, rgba(18,16,12,0.70) 0%, rgba(18,16,12,0.66) 36%, rgba(18,16,12,0.72) 68%, rgba(18,16,12,0.93) 100%)',
        }}
      />
      {/* Voile radial */}
      <div
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  onBlur={() => setFocused(null)}
                >
                  <option value="" style={{color: brand ?? '#12100c', background: '#faf8f4' }}>
                  ...
                  {PIECE_TYPES.map((pt) => (
                    <option
                      key={pt}
                      value={pt}
                      style={{color: brand ?? '#12100c', background: '#faf8f4' }}
                    >
                      {pt}
                    </option>
                  ))}
