    ...
    <div className="bg-[#fafafa] text-[#1a1a1a] font-sans min-h-dvh selection:bg-[#1a365d] selection:text-white overflow-x-hidden">
          ...
          <Link href="#hero" className="flex items-center gap-3 group">
            {fd?.logoBase64 ? (
              ...
              <>
                ...
                <span className="text-2xl font-bold tracking-tighter text-[#1a365d]">{/* NOM_LOGO */ clientName({ formData: fd }) ?? (<>Lumina<span className="font-light">Law</span></>)}</span>
              </>
            )}
          </Link>
          <div className="hidden lg:flex gap-10 text-[10px] font-bold uppercase tracking-[0.3em] text-black/40">
            {NAV.map(({ l, h }) => (
              <Link key={l} href={h} className="hover:text-[#1a365d] transition-colors">{l}</Link>
            ))}
          </div>
              ...
              <SheetContent side="right" className="bg-white border-black/5 p-12 text-black">
                <div className="flex flex-col gap-8 mt-16 text-left">
                  {[...NAV, { l: "Contact", h: "#contact" }].map(({ l, h }) => (
                    <Link key={l} href={h} className="text-3xl font-bold tracking-tighter hover:text-[#1a365d] transition-colors">{l}</Link>
                  ))}
                </div>
              </SheetContent>
            </Sheet>
      ...
      <main>
              ...
              <div>
                <Reveal>
                  <div className="inline-flex items-center gap-4 mb-5 md:mb-10">
                     ...
                     <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#1a365d]">{clientEyebrow(sessionData) ?? "Elite Legal Counsel"}</span>
                  </div>
                </Reveal>
                <Reveal delay={0.1} y={60}>
                  <h1 className="text-5xl sm:text-6xl md:text-[9rem] font-bold tracking-tighter leading-[0.95] md:leading-[0.8] text-[#1a1a1a] mb-6 md:mb-12 uppercase break-words" style={{ fontFamily: "serif" }}>{<>{clientHeroLine(sessionData, 0, 2, 9) ?? "Power"}<br/> <span className="text-[#1a365d] font-light italic italic-none">{clientHeroLine(sessionData, 1, 2, 9) ?? "In Truth."}</span>
                  </>}</h1>
                </Reveal>
                <Reveal delay={0.3}>
              ...
              <Reveal delay={0.5} y={0}>
                 <div className="relative hidden lg:block">
                    ...
                    <div className="relative aspect-[4/5] bg-white border border-black/5 p-3 rounded-sm shadow-2xl">
                       <ParallaxImg src={photo(0, (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1200"))} alt="Law Office" />
        ...
        <section id="services" className="py-40 bg-white relative overflow-hidden">
           ...
           <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
                 <div>
                    <Reveal>
                       <h2 className="text-5xl md:text-7xl font-bold uppercase text-[#1a1a1a] mb-16" style={{ fontFamily: "serif" }}>{/* TEXTE_SECTION */ clientText(sessionData, "services.titre") ?? (<>A Legacy <br/> Of <span className="italic font-light text-[#1a365d]">Excellence.</span></>)}</h2>
                 ...
                 <Reveal delay={0.3}>
                    <div className="aspect-[4/5] relative border border-black/5 p-4 bg-[#fafafa]">
                       <ParallaxImg src={photo(1, (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&q=80&w=1200"))} alt="Legal Gavel" />
        ...
        <section className="py-40 bg-[#fafafa] border-t border-black/5">
          <div className="max-w-6xl mx-auto px-6 md:px-12">
            <Reveal>
              ...
              <h2 className="text-4xl md:text-6xl font-bold text-[#1a365d] mb-20 leading-tight" style={{ fontFamily: "serif" }}>{/* TEXTE_SECTION */ clientText(sessionData, "section-5.titre") ?? (<>
        ...
        <section id="equipe" className="py-40 bg-white border-t border-black/5">
          <div className="max-w-6xl mx-auto px-6 md:px-12">
            <Reveal>
              <p className="text-[10px] uppercase tracking-[0.5em] text-[#1a365d]/40 mb-6">{tr({ formData: fd }, "Our Team")}</p>
              <h2 className="text-4xl md:text-6xl font-bold text-[#1a365d] mb-20 leading-tight" style={{ fontFamily: "serif" }}>{/* TEXTE_SECTION */ clientText(sessionData, "equipe.titre") ?? (<>
              ...
              {EQUIPE_INLINE.map((a, i) => (
                <Reveal key={a.name} delay={i * 0.1}>
                  <div className="flex flex-col gap-5">
                    ...
                    <div>
                      <div className="text-[10px] uppercase tracking-[0.3em] text-[#1a365d]/40 mb-1">Called {a.called}</div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <Reveal>
              <div className="mb-20 border-b border-black/10 pb-10">
                <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#1a365d] block mb-5">Insights</span>
                <h2 className="text-5xl md:text-7xl font-bold uppercase text-[#1a1a1a]" style={{ fontFamily: "serif" }}>{/* TEXTE_SECTION */ clientText(sessionData, "insights.titre") ?? (<>What We <span className="italic font-light text-[#1a365d]">Publish.</span></>)}</h2>
              </div>
            </Reveal>
              ...
              {INSIGHTS.map((n, i) => (
                <Reveal key={n.t} delay={i * 0.06}>
                  <article className="bg-[#f7f7f5] p-10 h-full">
                    <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#1a365d]">{n.k}</span>
        ...
        <section id="cases" className="py-40 bg-white">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <Reveal>
              <div className="mb-20 border-b border-black/10 pb-10">
                <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#1a365d] block mb-5">Case Studies</span>
                <h2 className="text-5xl md:text-7xl font-bold uppercase text-[#1a1a1a]" style={{ fontFamily: "serif" }}>{/* TEXTE_SECTION */ clientText(sessionData, "cases.titre") ?? (<>What We <span className="italic font-light text-[#1a365d]">Closed.</span></>)}</h2>
              </div>
            </Reveal>
              ...
              {CASES.map((c, i) => (
                <Reveal key={c.t} delay={i * 0.06}>
                  <div className="py-10 grid grid-cols-1 md:grid-cols-[180px_1fr] gap-8">
                    <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#1a365d] pt-2">{c.s}</span>
                    <div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-10">
               {[{ l: "LinkedIn", h: "https://linkedin.com" }, { l: "Journal", h: "#insights" }, { l: "Archive", h: "#cases" }, { l: "Contact", h: "#contact" }].map(s => (
                 <Link key={s.l} href={s.h} className="text-[10px] font-bold uppercase tracking-widest text-black/30 hover:text-[#1a365d] transition-colors">{s.l}</Link>
               ))}
            </div>
          </div>
