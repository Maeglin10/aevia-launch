        ...
        <Reveal>
          ...
          <div className="space-y-10 text-xs font-bold uppercase tracking-widest text-white/40 leading-relaxed">
            <section className="space-y-4">
              <h3 className="text-sm text-emerald-500 font-black">1. Publisher Information</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-sm text-emerald-500 font-black">3. Hosting</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-sm text-emerald-500 font-black">4. Disclaimer</h3>
              <p>
                This cyber platform simulation is for showcase purposes only. No real penetration testing or actual offensive operations are performed on user systems without explicit contract.
              </p>
            </section>
          </div>
        </Reveal>
