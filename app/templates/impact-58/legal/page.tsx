  ...
  return (
    <section style={{ padding: "6rem 3rem", minHeight: "calc(100vh - 120px)" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(1.8rem, 3.5vw, 3rem)", fontWeight: 800, color: C.text, letterSpacing: "-0.02em", leading-snug pb-2, marginBottom: "3rem" }}>
          Mentions Légales
        </h2>
