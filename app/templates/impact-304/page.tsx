...
let C: Record<string, string> = {
  primary: "var(--brand,#e53935)",
  primaryLight: "var(--brand-light,#f95858)",
  primaryDark: "#b71c1c",
  bg: "#0f1923",
  bgDeep: "#080f18",
  bgCard: "#162030",
...
const SERIF = "'Montserrat', sans-serif" as const;
...
function PHOTO_LIVE() {
  return {
  hero: (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=1600&auto=format&fit=crop"),
  about: (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=1600&auto=format&fit=crop"),
  special: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?q=80&w=1600&auto=format&fit=crop"),
  gallery1: (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=800&auto=format&fit=crop"),
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=800&auto=format&fit=crop"),
  gallery3: (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=800&auto=format&fit=crop"),
  gallery4: (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=800&auto=format&fit=crop")
} as const;
}
        ...
        <div style={{
          ...
          <Reveal delay={0.55}>
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="#contact" style={{ textDecoration: 'none' }}>
                <Button filled>Appel urgent 24h/7j</Button>
              </a>
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "1h", "label": "Intervention"}, {"value": "24h/7j", "label": "Disponibilité"}, {"value": "Quali", "label": "Artisans Agréés"}].map((stat, i) => (
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{clientName(sessionData) ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Rapido Plomberie Paris"))}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
                ...
                <p style={{
                  ...
                  {clientName(sessionData) ?? "Rapido Plomberie"} intervient en urgence sur tout {clientCity(sessionData) ?? "Paris"}. Fuite d'eau, chaudière en panne, installation PAC ou rénovation complète de salle de bain. Devis gratuit, travaux garantis.
                </>}</p>
                <p style={{
                  fontSize: 15,
                  lineHeight: 1.7,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Installation et maintenance de PAC air/eau et air/air. Aides MaPrimeRénov' et CEE disponibles. Devis en 48h.
            </p>
          </Reveal>
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <Reveal delay={0.15}>
              <div style={{
                ...
                {["Tous","Dépannage","Chauffage","Installation"].map((tab, i) => (
                  <button
                    key={i}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? fd?.phone ?? "+33574896541").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientPhone(sessionData) ?? fd?.phone ?? "+33 (0)5 00 00 00 00"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientEmail(sessionData) ?? fd?.email ?? "contact@rapidoplomberieparis.com"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 15, color: C.text, fontWeight: 700 }}>{fd?.city ?? "Paris"}</div>
                    </div>
                  </div>
                </div>
              </Reveal>
                ...
                <div style={{
                  ...
                  {formSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      ...
                      <Button type="submit" filled>Appel urgent 24h/7j</Button>
                    </form>
                  )}
                </div>
              </Reveal>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                Urgences 24h/7j · Bureau Lun–Ven 8h–18h
              </p>
            </div>
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6, fontSize: 12 }}>
                ...
                Responsable de publication: {clientName(sessionData) ?? "Rapido Plomberie Paris"}<br />
          ...
          <div style={{
            ...
            © {new Date().getFullYear()} {clientName(sessionData) ?? "Rapido Plomberie"} {clientCity(sessionData) ?? "Paris"}. Tous droits réservés.{/* VILLE_PIED */}{clientCity(sessionData) ? ` · ${clientCity(sessionData)}` : ""}
          </div>
        </div>
      </footer>
