...
function Footer() {
  const cols: { title: string; items: string[]; href: string }[] = [
    ...
    },
    {
      ...
      href: '#philosophie',
      items: ['Notre philosophie', 'Biodiversité', 'Garantie reprise 2 ans', (clientEmail(sessionData) ?? fd?.email ?? 'contact@atelierterranantes.fr'), (clientPhone(sessionData) ?? fd?.phone ?? '02 40 74 89 89')],
    },
  ];
