        ...
        <Reveal>
          ...
          <div className="space-y-10 text-xs font-bold uppercase tracking-widest text-white/40 leading-relaxed">
            <section className="space-y-4">
              <h3 className="text-sm text-orange-500 font-black">1. Publisher Information</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-sm text-orange-500 font-black">2. Contact</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-sm text-orange-500 font-black">3. Hosting</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-sm text-orange-500 font-black">4. Disclaimer</h3>
              <p>
                This roastery store simulation is for showcase purposes only. No real specialty coffee roasting, physical sales, or actual direct-trade transactions are conducted from this application interface.
              </p>
            </section>
          </div>
        </Reveal>
