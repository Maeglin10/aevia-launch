...
function ROOMS_LIVE() {
  return resolveList(clientServices(sessionData)?.map((s: any, i: number) => ({
      num: ROOMS_DEMO_ANNEXE[i % ROOMS_DEMO_ANNEXE.length].num,
      name: s.title ?? s.name,
      size: ROOMS_DEMO_ANNEXE[i % ROOMS_DEMO_ANNEXE.length].size,
      view: ROOMS_DEMO_ANNEXE[i % ROOMS_DEMO_ANNEXE.length].view,
      price: s.price ?? ROOMS_DEMO_ANNEXE[i % ROOMS_DEMO_ANNEXE.length].price,
      tag: ROOMS_DEMO_ANNEXE[i % ROOMS_DEMO_ANNEXE.length].tag,
      desc: s.description ?? s.desc ?? ROOMS_DEMO_ANNEXE[i % ROOMS_DEMO_ANNEXE.length].desc,
      img: ROOMS_DEMO_ANNEXE[i % ROOMS_DEMO_ANNEXE.length].img,
    })), ROOMS_DEMO_ANNEXE);
}
let ROOMS = ROOMS_DEMO_ANNEXE;
...
const EXPERIENCES_DEMO_ANNEXE = [
  {
    ...
    img: 'https://images.pexels.com/photos/13871328/pexels-photo-13871328.jpeg?auto=compress&cs=tinysrgb&w=1600',
  },
  {
    label: 'Espace Étoile',
...
function ROOMS_FULL_LIVE(): RoomFull[] {
  return [
  {
    slug: 'prestige-room',
    name: 'Prestige Room',
...
let ROOMS_FULL: RoomFull[] = ROOMS_FULL_LIVE();
...
function ParallaxDivider() {
  return (
    <ParallaxSection
      imgSrc="https://images.pexels.com/photos/13871310/pexels-photo-13871310.jpeg?auto=compress&cs=tinysrgb&w=1600"
      speed={0.35}
      height="55vh"
    ...
    >
      ...
      <motion.div
        style={{
          ...
          width: '45vw',
          height: '80%',
          backgroundImage: 'url(https://images.pexels.com/photos/13871328/pexels-photo-13871328.jpeg?auto=compress&cs=tinysrgb&w=1600)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          y: bgY,
          opacity: 0.18,
      ...
      >
        ...
        <BlurReveal delay={0.4}>
          <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            >
              {clientEmail(sessionData) ?? fd?.email ?? "reservations@grandpalais.fr"}
            </a>
          </div>
        </BlurReveal>
      </div>
      ...
      <div style={{ maxWidth: '75rem', margin: '0 auto' }}>
        ...
        >
          <span style={{ fontFamily: SANS, fontSize: '0.58rem', color: `${CREAM}35`, letterSpacing: '0.08em' }}>
            © 2026 {clientName(sessionData) ?? "Grand Palais"}. Tous droits réservés.
          </span>
  ...
  return (
    <div>
      <SubPageHero
        ...
        img="https://images.pexels.com/photos/13871310/pexels-photo-13871310.jpeg?auto=compress&cs=tinysrgb&w=1600"
      />
...
export default function GrandPalaisPage() {
  ...
  const [page, setPage] = useState<HotelPage>('contact');
