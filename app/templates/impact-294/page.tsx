                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>contact@sultankebab&grill.com</a>
                    </div>
                  </div>
