          ...
          <Reveal delay={0.1}>
            <div style={{
              ...
              <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#ffffff', fontWeight: 600 }}>
                Kebab & grill · Marseille Noailles
              </span>
            </div>
          </Reveal>
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>Sultan Kebab & Grill</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
      ...
      <section id="faq" style={{ padding: '120px 24px', background: C.bgDeep }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[{"q":"Vos viandes sont-elles fraîches ?","a":"Oui, notre broche de veau et dinde est montée chaque matin dans notre laboratoire par nos chefs bouchers. Nous n'utilisons aucun produit surgelé pour nos broches."},{"q":"Quelles sont les options pour le Click & Collect ?","a":"Vous commandez en ligne et vous venez chercher votre commande chaude en 15 minutes sans faire la queue."},{"q":"Faites-vous les livraisons ?","a":"Oui, via nos partenaires exclusifs Deliveroo et Uber Eats dans tout Marseille."}].map((item, i) => (
