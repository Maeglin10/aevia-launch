...
let C: Record<string, string> = {
  primary: "var(--brand,#b5651d)",
  primaryLight: "var(--brand-light,#d4813a)",
  primaryDark: "#8b4c16",
  bg: "#ffffff",
  bgDeep: "#fdf8f3",
  bgCard: "#fdf4eb",
...
const SANS = "'Poppins', sans-serif" as const;

const EASE: [number, number, number, number] = [0.16, 1, 0.3, 1];

function PHOTO_LIVE() {
  return {
  hero: (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1625813506062-0aeb1d7a094b?q=80&w=1600&auto=format&fit=crop"),
  about: (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1541518763669-27fef04b14ea?q=80&w=1600&auto=format&fit=crop"),
  special: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1509358271058-acd22cc93898?q=80&w=1600&auto=format&fit=crop"),
  gallery1: (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1625813506062-0aeb1d7a094b?q=80&w=800&auto=format&fit=crop"),
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?q=80&w=800&auto=format&fit=crop"),
  gallery3: (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1606787366850-de6330128bfc?q=80&w=800&auto=format&fit=crop"),
  gallery4: (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=800&auto=format&fit=crop")
} as const;
}
...
return (
    <div style={{
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400&display=swap');
      `}</style>
        ...
        <div style={{
          ...
          <a href="#hero" style={{
            ...
            {fd?.logoBase64 ? (
              ...
              (clientName(sessionData) ?? (clientName(sessionData) ?? "Sultan Kebab & Grill"))
            )}
          </a>
      ...
      >
        <motion.div style={{
          ...
          <img 
            src={PHOTO.hero} 
            alt="Hero image showing Sultan Kebab & Grill core business" 
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "100%", "label": "Viande Halal"}, {"value": "15", "label": "Épices Maison"}, {"value": "10 min", "label": "Click & Collect"}].map((stat, i) => (
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{clientName(sessionData) ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Sultan Kebab & Grill"))}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
                ...
                <p style={{
                  ...
                  Depuis 2015, Sultan Kebab régale le quartier Noailles avec des recettes familiales du Liban et de Turquie. Viande halal certifiée, épices fraîches broyées chaque matin.
                </>}</p>
                <p style={{
                  fontSize: 15,
                  lineHeight: 1.7,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Assiette kebab + boisson + dessert à 12€. Disponible en semaine 11h–15h.
            </p>
          </Reveal>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? clientEmail(sessionData) ?? fd?.email ?? "+33522651954").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>+33 (0)5 00 00 00 00</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>contact@sultankebab&grill.com</a>
                    </div>
                  </div>
