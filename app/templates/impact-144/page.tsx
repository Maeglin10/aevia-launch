        ...
        <section id="about" className="py-32 bg-[#0a0506] border-t border-white/5">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { name: "Aki Sato", role: "Creative Director", img: photo(4, "https://images.pexels.com/photos/240566/pexels-photo-240566.jpeg?auto=compress&cs=tinysrgb&w=1600") },
                { name: "Leo Croft", role: "Lead Motion Designer", img: photo(5, "https://images.pexels.com/photos/326518/pexels-photo-326518.jpeg?auto=compress&cs=tinysrgb&w=1600") },
