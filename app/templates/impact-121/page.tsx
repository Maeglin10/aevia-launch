  ...
  projects: [
    {
      ...
      category: "E-Commerce",
      img: (clientPhotos(sessionData)[0] || "https://images.pexels.com/photos/9617886/pexels-photo-9617886.jpeg?auto=compress&cs=tinysrgb&w=1600"),
      color: "#f3f4f6"
    },
    {
      client: "Vanguard",
        ...
        <section id="contact" className="py-32 md:py-40 px-6 md:px-12 bg-zinc-900 text-white rounded-t-[3rem] -mt-10 relative z-20 overflow-hidden">
          ...
          <div className="max-w-[1800px] mx-auto relative z-10 text-center">
            ...
            <div className="mt-24 flex flex-col md:flex-row items-center justify-between text-zinc-500 font-medium">
              <div>© 2026 {clientName(sessionData) ?? "Folio Studio."} Tous droits réservés.{/* VILLE_PIED */}{clientCity(sessionData) ? ` · ${clientCity(sessionData)}` : ""}</div>
