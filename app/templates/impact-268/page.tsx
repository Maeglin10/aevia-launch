...
let C: Record<string, string> = {
  ...
  bgDarkAlt: '#060c04',
  bgCard: '#ffffff',
  accent: 'var(--brand,#4a7a3a)',
  accentDark: 'var(--brand-light,#366030)',
  accentLight: '#c8dcc0',
  white: '#ffffff',
  ink: '#0a1408',
  textMuted: '#284020',
    ...
    <>
      ...
      <div className="vh-navcta">
        ...
        @media (max-width: 860px) {
          ...
          .vh-burger { display: flex !important; flex-direction: column; }
...
function Hero() {
  ...
  return (
    <section id="hero" ref={ref} style={section}>
      ...
      <div
        style={{
          ...
          background:
            ...
            'linear-gradient(to bottom, rgba(10,20,8,0.70) 0%, rgba(10,20,8,0.66) 36%, rgba(10,20,8,0.72) 68%, rgba(10,20,8,0.92) 100%)',
        }}
      />
      <div
        style={{
      ...
      {clientAccrocheRestante(sessionData, 1, 9) && (
