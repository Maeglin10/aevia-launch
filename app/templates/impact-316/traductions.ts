...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  fr: {
    "clients b2b actifs": "Clients B2B actifs",
  },
  es: {
    ...
    "clients b2b actifs": "Clientes B2B activos",
  },
  de: {
    ...
    "clients b2b actifs": "Aktive B2B-Kunden",
  },
  pt: {
    ...
    "collection": "Coleção",
    "clients b2b actifs": "Clientes B2B ativos",
  },
};
