          ...
          <section id="hero" ref={heroRef} className="relative h-dvh overflow-hidden pt-20">
            <div className="grid grid-cols-1 md:grid-cols-2 h-full">
              <motion.div className="relative overflow-hidden" style={{ y: heroY }}>
                <Image src={photo(0, "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=900&q=90")} alt={fd?.businessName ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Noir Couture"))} fill className="object-cover" priority />
              </motion.div>
