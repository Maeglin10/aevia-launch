          ...
          <section id="hero" ref={heroRef} className="relative h-dvh overflow-hidden pt-20">
            <div className="grid grid-cols-1 md:grid-cols-2 h-full">
              <motion.div className="relative overflow-hidden" style={{ y: heroY }}>
                <Image src={photo(7, "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=900&q=90")} alt={fd?.businessName ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Noir Couture"))} fill className="object-cover" priority />
              </motion.div>
...
function CollectionsSubPage({ goTo, activeCol, setActiveCol }: { goTo: (p: any) => void; activeCol: number; setActiveCol: (i: number) => void }) {
  const collectionsList = resolveList(
    clientServices(sessionData)?.map((s: any, i: number) => ({ ...([
    {
      ...
      image: photo(8, "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&q=80"),
    },
    {
      name: "L'Invisible",
      season: "AW 2025",
      ...
      image: photo(9, "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=800&q=80"),
    },
    {
      name: "Monochrome",
      season: "Resort 2026",
      ...
      image: photo(10, "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=800&q=80"),
    }
  ])[i % ([
    {
      name: "Couture Noire",
      ...
      inspiration: "L'architecture brutaliste parisienne et la poésie des ombres portées.",
      piecesCount: "24 pièces exclusives",
      image: photo(11, "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&q=80"),
    },
    {
      name: "L'Invisible",
      season: "AW 2025",
      ...
      inspiration: "Les brumes d'automne sur la Seine et le travail des volumes de Cristobal Balenciaga.",
      piecesCount: "18 pièces d'archives",
      image: photo(12, "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=800&q=80"),
    },
    {
      name: "Monochrome",
      season: "Resort 2026",
      ...
      inspiration: "La lumière de la mer Égée en hiver et le minimalisme des années 90.",
      piecesCount: "12 pièces limitées",
      image: photo(13, "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=800&q=80"),
    }
    ...
    [
    {
      ...
      inspiration: "L'architecture brutaliste parisienne et la poésie des ombres portées.",
      piecesCount: "24 pièces exclusives",
      image: photo(14, "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&q=80"),
    },
    {
      name: "L'Invisible",
      season: "AW 2025",
      ...
      inspiration: "Les brumes d'automne sur la Seine et le travail des volumes de Cristobal Balenciaga.",
      piecesCount: "18 pièces d'archives",
      image: photo(15, "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=800&q=80"),
    },
    {
      name: "Monochrome",
      season: "Resort 2026",
      ...
      inspiration: "La lumière de la mer Égée en hiver et le minimalisme des années 90.",
      piecesCount: "12 pièces limitées",
      image: photo(16, "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=800&q=80"),
    }
  ],
  );
      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-[450px] overflow-hidden">
            <img
              src={photo(27, "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&q=80")}
              alt="Atelier couture"
        ...
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5 space-y-8 text-sm text-white/60">
            ...
            <div className="space-y-2">
              ...
              <p>{clientEmail(sessionData) ?? fd?.email ?? "showroom@noir-couture.com"}</p>
            </div>
          </div>
