...
export default function NeuralisPage() {
  ...
  return (
    <div className="premium-theme min-h-dvh bg-[#020204] text-[#e0e0e0] font-sans selection:bg-[#00f2ff] selection:text-black overflow-x-hidden">
      ...
      <section id="hero" className="relative h-[100svh] flex items-center overflow-hidden pt-36 md:pt-0">
        <div className="absolute inset-0">
          <Image src={photo(5, "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1600&q=80")} alt="Cyber Grid" fill className="object-cover opacity-20 mix-blend-screen" priority />
              ...
              {STATS.map((stat, i) => (
                <Reveal key={i} delay={i * 0.1}>
                   <div className="text-center md:text-left">
                      <div className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#00f2ff] mb-2">{stat.label}</div>
         ...
         <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <Reveal>
               <div className="text-center mb-32">
                  ...
                  <h2 className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase">{/* TEXTE_SECTION */ clientText(sessionData, "section-4.titre") ?? (<>Bio-Digital <span className="text-[#00f2ff] not-italic">Synthesis.</span></>)}</h2>
               </div>
            </Reveal>
               ...
               {INNOVATIONS.map((s, i) => (
                 <Reveal key={i} delay={i * 0.1}>
                    <div className="p-16 border border-white/5 bg-white/[0.01] hover:border-[#00f2ff]/30 transition-all group h-full flex flex-col relative overflow-hidden">
                       ...
                       <button className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.3em] text-[#00f2ff] group-hover:gap-6 transition-all">
         ...
         <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            <Reveal>
               <div className="relative aspect-square rounded-sm overflow-hidden group border border-white/5">
                  <Image src={photo(6, "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&q=80")} alt="Bio Lab" fill className="object-cover group-hover:scale-110 transition-all duration-[3s] mix-blend-screen opacity-60" />
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
           <Reveal>
              <div className="mb-32">
                 ...
                 <h2 className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase text-white">{/* TEXTE_SECTION */ clientText(sessionData, "section-6.titre") ?? (<>Clinical <br/> <span className="text-[#00f2ff] not-italic">Validation.</span></>)}</h2>
              </div>
           </Reveal>
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
           <Reveal>
              <div className="relative aspect-video rounded-sm overflow-hidden border border-white/5 group">
                 <Image src={photo(7, "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&q=80")} alt="Security" fill className="object-cover opacity-40 group-hover:scale-110 transition-transform duration-[3s]" />
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
           <Reveal>
              <div className="mb-32 text-center">
                 ...
                 <h2 className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase text-white">{/* TEXTE_SECTION */ clientText(sessionData, "section-8.titre") ?? (<>Global <span className="text-[#00f2ff] not-italic">Nodes.</span></>)}</h2>
              </div>
           </Reveal>
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
           <Reveal>
              <div className="mb-32">
                 ...
                 <h2 className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase text-white">{/* TEXTE_SECTION */ clientText(sessionData, "section-10.titre") ?? (<>Full <br/> <span className="text-[#00f2ff] not-italic">Manifesto.</span></>)}</h2>
              </div>
           </Reveal>
        ...
        <div className="max-w-4xl mx-auto px-6">
           <Reveal>
              <div className="mb-24 text-center">
                 <h2 className="text-5xl font-black italic uppercase tracking-tighter text-white mb-8">{/* TEXTE_SECTION */ clientText(sessionData, "about.titre") ?? (<>Common <span className="text-[#00f2ff] not-italic">Queries.</span></>)}</h2>
