...
let C: Record<string, string> = {
  primary: "var(--brand,#0e9999)",
  primaryLight: "var(--brand-light,#15b8b8)",
  primaryDark: "#0a7070",
  bg: "#f8fcfc",
  bgDeep: "#eef8f8",
  bgCard: "#ffffff",
...
const SERIF = "'EB Garamond', serif" as const;
...
export default function Page() {
  ...
  const servicesReal: any[] | null = clientServices(sessionData) ?? null;
  const SERVICES_DEMO = resolveList(clientServices(sessionData)?.map((s: any, i: number) => ({ ...([{"name": "Bilan Dentaire & Détartrage", "category": "Soins", "desc": "Examen bucco-dentaire complet, nettoyage professionnel, conseils d'hygiène.", "price": "43,43 €"}, {"name": "Blanchiment Professionnel", "category": "Esthétique", "desc": "Traitement de blanchiment au fauteuil avec gel certifié et lampe LED.", "price": "450,00 €"}, {"name": "Traitement Aligneurs Invisibles", "category": "Esthétique", "desc": "Orthodontie invisible par gouttières amovibles transparentes sur mesure.", "price": "Sur Devis"}, {"name": "Pose d'Implant Dentaire", "category": "Implants", "desc": "Remplacement d'une dent manquante par une racine artificielle en titane.", "price": "Sur Devis"}])[i % ([{"name": "Bilan Dentaire & Détartrage", "category": "Soins", "desc": "Examen bucco-dentaire complet, nettoyage professionnel, conseils d'hygiène.", "price": "43,43 €"}, {"name": "Blanchiment Professionnel", "category": "Esthétique", "desc": "Traitement de blanchiment au fauteuil avec gel certifié et lampe LED.", "price": "450,00 €"}, {"name": "Traitement Aligneurs Invisibles", "category": "Esthétique", "desc": "Orthodontie invisible par gouttières amovibles transparentes sur mesure.", "price": "Sur Devis"}, {"name": "Pose d'Implant Dentaire", "category": "Implants", "desc": "Remplacement d'une dent manquante par une racine artificielle en titane.", "price": "Sur Devis"}]).length], name: s.title, desc: s.desc || "" , ...(s.price ? { price: s.price } : {})})), [{"name": "Bilan Dentaire & Détartrage", "category": "Soins", "desc": "Examen bucco-dentaire complet, nettoyage professionnel, conseils d'hygiène.", "price": "43,43 €"}, {"name": "Blanchiment Professionnel", "category": "Esthétique", "desc": "Traitement de blanchiment au fauteuil avec gel certifié et lampe LED.", "price": "450,00 €"}, {"name": "Traitement Aligneurs Invisibles", "category": "Esthétique", "desc": "Orthodontie invisible par gouttières amovibles transparentes sur mesure.", "price": "Sur Devis"}, {"name": "Pose d'Implant Dentaire", "category": "Implants", "desc": "Remplacement d'une dent manquante par une racine artificielle en titane.", "price": "Sur Devis"}]);
    ...
    <div style={{
      ...
      >
        <motion.div style={{
          ...
          <img 
            src={PHOTO.hero} 
            alt={`Hero image showing ${clientName(sessionData) ?? "Dr. Estelle Blanc"} core business`} 
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "100%", "label": "Cabinet Digitalisé"}, {"value": "6-18 mois", "label": "Orthodontie Invisible"}, {"value": "3D", "label": "Scanner Numérique"}].map((stat, i) => (
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Aligneurs transparents sur mesure. Discrets, confortables, résultats en 6 à 18 mois selon votre cas.
            </p>
          </Reveal>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? fd?.phone ?? "+33526133123").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientPhone(sessionData) ?? fd?.phone ?? "+33 (0)5 00 00 00 00"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientEmail(sessionData) ?? fd?.email ?? "contact@dr.estelleblanc.com"}</a>
                    </div>
                  </div>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                {clientTrade(sessionData) ?? "Chirurgien-dentiste"} {clientCity(sessionData) ?? "Montpellier Antigone"}
              </p>
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                Lun–Ven 9h–19h · Sur rendez-vous
              </p>
            </div>
