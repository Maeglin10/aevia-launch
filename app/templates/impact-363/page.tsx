...
const HERO = [
  { k: "La semelle sur mesure", sub: "Construite couche par couche, au cabinet.", tiles: [{ icon: Scan, t: "1. L'empreinte", d: "Plateforme de pression et scan 3D : votre appui, mesuré pas deviné.", bg: "#d9ecea", fg: "#135e57" }, { icon: Footprints, t: "2. La correction", d: "Éléments posés au dixième de millimètre selon l'examen clinique.", bg: "#0f2523", fg: "#d9ecea" }, { icon: Activity, t: "3. Le contrôle", d: "Re-testée sur plateforme à un mois, ajustée gratuitement.", bg: "#e9f2f1", fg: "#135e57" }] },
  { k: "La pédicurie médicale", sub: "Les soins que l'on n'ose pas demander.", tiles: [{ icon: Footprints, t: "Cors & durillons", d: "Traités à l'instrument stérile, cause mécanique corrigée.", bg: "#0f2523", fg: "#d9ecea" }, { icon: Activity, t: "Ongles incarnés", d: "Soins et orthonyxie : la pince à ongles n'est pas une fatalité.", bg: "#d9ecea", fg: "#135e57" }, { icon: Scan, t: "Pied diabétique", d: "Gradation du risque, soins remboursés, prévention des plaies.", bg: "#e9f2f1", fg: "#135e57" }] },
  { k: "Le sport", sub: "Courir plus, se blesser moins.", tiles: [{ icon: Activity, t: "Analyse de course", d: "Tapis instrumenté, vidéo : la foulée décortiquée image par image.", bg: "#e9f2f1", fg: "#135e57" }, { icon: Scan, t: "Semelles sport", d: "Fines, dynamiques, adaptées à la chaussure et à la discipline.", bg: "#d9ecea", fg: "#135e57" }, { icon: Footprints, t: "Suivi de saison", d: "Contrôles avant marathon et reprise après blessure.", bg: "#0f2523", fg: "#d9ecea" }] }
];
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          {fd?.logoBase64 ? (
            ...
            <>
              ...
              <span style={{ fontFamily: FONT, fontSize: 18, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{fd?.businessName ?? "Cabinet Podo'Marche"}</span>
...
<section className="i363-hero" style={{ minHeight: "100dvh", display: "grid", gridTemplateColumns: "minmax(0,1.08fr) minmax(0,0.92fr)", gap: 56, alignItems: "center", padding: "140px 64px 70px", maxWidth: 1260, margin: "0 auto" }}>
        <div>
          <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} style={{ fontSize: 12, fontWeight: 700, letterSpacing: 4, textTransform: "uppercase", color: C.accentDark }}>
            Pédicure-podologue · Clermont-Ferrand
          </motion.span>
      ...
      <section id="engagements" className="i363-pad" style={{ padding: "96px 64px", background: C.bgSection }}>
        <div className="i363-split" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 64, alignItems: "center" }}>
          <Reveal>
            <div style={{ borderRadius: 12, border: `1px solid ${C.border}`, background: C.accentLight, aspectRatio: "4/3", justifyContent: "center" , overflow: "hidden" }}><img src={photo(0, "https://images.pexels.com/photos/5619447/pexels-photo-5619447.jpeg?auto=compress&cs=tinysrgb&w=1400")} alt="Soin de pédicurie au cabinet" loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} /></div>
          </Reveal>
          <Reveal delay={0.15}>
            <div>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 16 }}>
              ...
              <h2 style={{ fontFamily: FONT, fontSize: "clamp(28px, 3.5vw, 44px)", color: C.text, marginTop: 10 }}>Annoncés, <em>mutuelles décodées.</em></h2>
      ...
      <section className="i363-pad" style={{ padding: "96px 64px", background: C.bgDark }}>
        <Reveal>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontFamily: FONT, fontSize: "clamp(26px, 3.4vw, 42px)", color: "#fff" }}>Ils marchent <em style={{ color: C.hi }}>sans y penser</em>.</h2>
          </div>
        </Reveal>
      ...
      <footer className="i363-pad" style={{ background: C.bgDark, padding: "44px 64px 22px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 28, marginBottom: 30 }}>
            <div>
              <div style={{ fontFamily: FONT, fontSize: 18, color: C.hi, marginBottom: 8 }}>{fd?.businessName ?? "Cabinet Podo'Marche"}</div>
              <p style={{ color: "rgba(255,255,255,0.38)", fontSize: 13, lineHeight: 1.7 }}>Pédicures-podologues D.E. · Clermont-Ferrand<br />Ordre national des pédicures-podologues — n° ADELI affichés</p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {[{ icon: <MapPin size={13} />, t: "Clermont-Ferrand, Puy-de-Dôme" }, { icon: <Phone size={13} />, t: phone }, { icon: <Clock size={13} />, t: "Lun–Ven 8h30–19h · Sam 8h30–13h" }].map((item, idx) => (
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Cabinet Podo'Marche"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
