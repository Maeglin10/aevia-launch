...
let C: Record<string, string> = {
  ...
  bgDarkAlt: '#130d09',
  bgCard: '#ffffff',
  accent: 'var(--brand,#9b7248)',
  accentDark: 'var(--brand-light,#7a5838)',
  accentLight: '#ecdccc',
  white: '#ffffff',
  ink: '#1c140e',
  textMuted: '#5c4030',
      ...
      <div
        style={{
          ...
          background:
            ...
            'linear-gradient(to bottom, rgba(28,20,14,0.70) 0%, rgba(28,20,14,0.66) 36%, rgba(28,20,14,0.72) 68%, rgba(28,20,14,0.92) 100%)',
        }}
      />
      <div
        style={{
