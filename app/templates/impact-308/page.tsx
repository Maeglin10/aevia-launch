...
const PHOTO = {
  ...
  special: "https://images.unsplash.com/photo-1528570681816-40742111d4e7?q=80&w=1600&auto=format&fit=crop",
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          ...
          }}>{fd?.businessName ?? "Re-Thread Studio"}</a>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            © {new Date().getFullYear()} Re-Thread Studio. Tous droits réservés.
          </div>
        </div>
      </footer>
