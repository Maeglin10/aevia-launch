...
function COLLECTION_DEMO_LIVE() {
  return [
  { name: "Horology One", series: "Precision Series", price: "€14,500", img: (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"), desc: "Brushed titanium case with a 72-hour power reserve and sapphire crystal." },
  { name: "Deep Sea", series: "Oceanic Series", price: "€18,200", img: (clientPhotos(sessionData)[1] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200"), desc: "Professional diver's watch water resistant to 1000m with helium escape valve." },
  { name: "Lunar Phase", series: "Astral Series", price: "€22,900", img: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"), desc: "Perpetual moon phase complication with 18k rose gold hand-engraved dial." },
];
}
let COLLECTION_DEMO = COLLECTION_DEMO_LIVE();
          ...
          <>
            ...
            <section id="hero" className="relative h-dvh flex items-center justify-center overflow-hidden pt-24 md:pt-0">
              <div className="absolute inset-0">
                <Image src={photo(0, (clientPhotos(sessionData)[3] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=2400"))} alt="Chronos Watch" fill className="object-cover opacity-40 scale-105" priority />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                  <Reveal>
                    <div className="relative aspect-square">
                      <ParallaxImg src={photo(1, (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))} alt="Atelier Detail" />
      ...
      <div className="max-w-[1200px] mx-auto px-6 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
          <div className="relative aspect-[4/3] border border-white/10 p-2">
            <img src={photo(2, (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))} alt="Watchmaker hands" className="w-full h-full object-cover" />
          </div>
          <div>
...
function CollectionPage({ goTo }: { goTo: (p: ActivePage) => void }) {
  const collectionList = resolveList(
    clientServices(sessionData)?.map((s: any, i: number) => ({ ...([
    { name: "Horology One", series: "Precision Series", price: "€14,500", img: photo(3, (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200")), calibre: "CH-01 Manual", power: "72 Hours", case: "Titanium Grade 5", water: "50m", desc: "Brushed titanium case with a 72-hour power reserve and sapphire crystal." },
    { name: "Deep Sea", series: "Oceanic Series", price: "€18,200", img: photo(4, (clientPhotos(sessionData)[7] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200")), calibre: "CH-09 Auto", power: "60 Hours", case: "Stainless Steel 904L", water: "1000m", desc: "Professional diver's watch water resistant to 1000m with helium escape valve." },
    { name: "Lunar Phase", series: "Astral Series", price: "€22,900", img: photo(5, (clientPhotos(sessionData)[8] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200")), calibre: "CH-12 Lunar", power: "65 Hours", case: "18k Rose Gold", water: "30m", desc: "Perpetual moon phase complication with 18k rose gold hand-engraved dial." },
    { name: "Tourbillon Prestige", series: "Grand Complication", price: "€85,000", img: photo(6, (clientPhotos(sessionData)[9] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200")), calibre: "CH-50 Tourbillon", power: "80 Hours", case: "Platinum 950", water: "30m", desc: "Flying tourbillon with manual winding, hand-beveled titanium cage, and power reserve indicator." }
  ])[i % ([
    { name: "Horology One", series: "Precision Series", price: "€14,500", img: photo(3, (clientPhotos(sessionData)[10] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200")), calibre: "CH-01 Manual", power: "72 Hours", case: "Titanium Grade 5", water: "50m", desc: "Brushed titanium case with a 72-hour power reserve and sapphire crystal." },
    { name: "Deep Sea", series: "Oceanic Series", price: "€18,200", img: photo(4, (clientPhotos(sessionData)[11] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200")), calibre: "CH-09 Auto", power: "60 Hours", case: "Stainless Steel 904L", water: "1000m", desc: "Professional diver's watch water resistant to 1000m with helium escape valve." },
    { name: "Lunar Phase", series: "Astral Series", price: "€22,900", img: photo(5, (clientPhotos(sessionData)[12] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200")), calibre: "CH-12 Lunar", power: "65 Hours", case: "18k Rose Gold", water: "30m", desc: "Perpetual moon phase complication with 18k rose gold hand-engraved dial." },
    { name: "Tourbillon Prestige", series: "Grand Complication", price: "€85,000", img: photo(6, (clientPhotos(sessionData)[13] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200")), calibre: "CH-50 Tourbillon", power: "80 Hours", case: "Platinum 950", water: "30m", desc: "Flying tourbillon with manual winding, hand-beveled titanium cage, and power reserve indicator." }
  ]).length], name: s.title, desc: s.desc || "" })),
    [
    { name: "Horology One", series: "Precision Series", price: "€14,500", img: photo(3, (clientPhotos(sessionData)[14] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200")), calibre: "CH-01 Manual", power: "72 Hours", case: "Titanium Grade 5", water: "50m", desc: "Brushed titanium case with a 72-hour power reserve and sapphire crystal." },
    { name: "Deep Sea", series: "Oceanic Series", price: "€18,200", img: photo(4, (clientPhotos(sessionData)[15] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200")), calibre: "CH-09 Auto", power: "60 Hours", case: "Stainless Steel 904L", water: "1000m", desc: "Professional diver's watch water resistant to 1000m with helium escape valve." },
    { name: "Lunar Phase", series: "Astral Series", price: "€22,900", img: photo(5, (clientPhotos(sessionData)[16] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200")), calibre: "CH-12 Lunar", power: "65 Hours", case: "18k Rose Gold", water: "30m", desc: "Perpetual moon phase complication with 18k rose gold hand-engraved dial." },
    { name: "Tourbillon Prestige", series: "Grand Complication", price: "€85,000", img: photo(6, (clientPhotos(sessionData)[17] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200")), calibre: "CH-50 Tourbillon", power: "80 Hours", case: "Platinum 950", water: "30m", desc: "Flying tourbillon with manual winding, hand-beveled titanium cage, and power reserve indicator." }
  ],
  );
          ...
          {[
            {
              ...
              img: photo(7, (clientPhotos(sessionData)[18] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
            },
            {
              num: "02",
              ...
              img: photo(8, (clientPhotos(sessionData)[19] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200"))
            },
            {
              num: "03",
              ...
              img: photo(9, (clientPhotos(sessionData)[20] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
            }
          ].map((item, idx) => (
      ...
      <div className="max-w-[1200px] mx-auto px-6 font-sans">
        ...
        <div className="mt-24 border border-white/5 p-12 bg-[#0c0c0c] flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/3 aspect-square relative">
            <img src={photo(10, (clientPhotos(sessionData)[21] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200"))} alt="Innovation Detail" className="w-full h-full object-cover" />
          </div>
...
function JournalPage() {
  const articles = resolveList(
    clientServices(sessionData)?.map((s: any, i: number) => ({ ...([
    {
      ...
      img: photo(11, (clientPhotos(sessionData)[22] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
    },
    {
      ...
      img: photo(12, (clientPhotos(sessionData)[23] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200"))
    },
    {
      ...
      img: photo(13, (clientPhotos(sessionData)[24] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
    }
  ])[i % ([
    {
      title: "The Art of Anglage: Hand-Beveling",
      ...
      date: "May 14, 2026",
      desc: "An exploration of the technique of hand-polishing sharp edges in high watchmaking.",
      img: photo(11, (clientPhotos(sessionData)[25] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
    },
    {
      title: "Helium Escape Valves: Deep Oceanic Design",
      cat: "Engineering",
      date: "April 28, 2026",
      desc: "How our watches survive the decompression phase of professional saturation diving.",
      img: photo(12, (clientPhotos(sessionData)[26] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200"))
    },
    {
      title: "Restoring a 1930 Perpetual Calendar",
      cat: "Restoration",
      date: "March 10, 2026",
      desc: "A behind-the-scenes look at reviving one of Leo Aris's early lunar complications.",
      img: photo(13, (clientPhotos(sessionData)[27] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
    }
    ...
    [
    {
      ...
      date: "May 14, 2026",
      desc: "An exploration of the technique of hand-polishing sharp edges in high watchmaking.",
      img: photo(11, (clientPhotos(sessionData)[28] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
    },
    {
      title: "Helium Escape Valves: Deep Oceanic Design",
      cat: "Engineering",
      date: "April 28, 2026",
      desc: "How our watches survive the decompression phase of professional saturation diving.",
      img: photo(12, (clientPhotos(sessionData)[29] || "https://images.pexels.com/photos/209255/pexels-photo-209255.jpeg?auto=compress&cs=tinysrgb&w=1200"))
    },
    {
      title: "Restoring a 1930 Perpetual Calendar",
      cat: "Restoration",
      date: "March 10, 2026",
      desc: "A behind-the-scenes look at reviving one of Leo Aris's early lunar complications.",
      img: photo(13, (clientPhotos(sessionData)[30] || "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"))
    }
  ],
  );
