...
function CollectionPage({ goTo }: { goTo: (p: ActivePage) => void }) {
  const collectionList = resolveList(
    ...
    { name: "Lunar Phase", series: "Astral Series", price: "€22,900", img: photo(8, "https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&q=80&w=1200"), calibre: "CH-12 Lunar", power: "65 Hours", case: "18k Rose Gold", water: "30m", desc: "Complication de phase de lune perpétuelle, cadran or rose 18 carats gravé à la main." },
