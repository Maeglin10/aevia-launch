...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  ...
  es: {
    ...
    "on t'attend": "Te estamos esperando",
    "repars avec un plan.": "regresa con un plan.",
    "un plan d'heures,": "Un plan de horas,",
  },
  de: {
  ...
  pt: {
    ...
    "collection": "Coleção",
    "on t'attend": "Estamos à tua espera",
    "repars avec un plan.": "volta com um plano.",
    "un plan d'heures,": "Um plano de horas,",
  },
};
