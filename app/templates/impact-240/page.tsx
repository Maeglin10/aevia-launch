...
let C: Record<string, string> = {
  ...
  bgCard: '#161616',
  bgCardHover: '#1e1e1e',
  accent: 'var(--brand,#e63c1e)',
  accentDim: 'var(--brand-light,#c02e14)',
  white: '#f2f2f2',
  textMuted: '#8a8a8a',
  textFaint: '#555555',
  border: '#252525',
      ...
      <div
        style={{
          ...
          background:
            ...
            'linear-gradient(to bottom, rgba(10,10,10,0.70) 0%, rgba(10,10,10,0.66) 36%, rgba(10,10,10,0.72) 68%, rgba(10,10,10,0.92) 100%)',
        }}
      />
      <div
        style={{
