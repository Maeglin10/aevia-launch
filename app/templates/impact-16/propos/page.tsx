            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-32">
              ...
              <div className="lg:col-span-7">
                ...
                <div className="flex gap-4">
                  <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@obscura.fr"}`} className="bg-[#C9A86C] text-black text-xs tracking-widest uppercase px-8 py-4 rounded-xl hover:bg-[#B8975E] transition-colors flex items-center gap-2 font-mono"><Mail className="w-4 h-4" /> {clientEmail(sessionData) ?? fd?.email ?? "contact@obscura.fr"}</a>
