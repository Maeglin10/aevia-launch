    ...
    <section style={sec} id="financement">
      ...
      <div style={{ maxWidth: 1260, margin: '0 auto 60px', textAlign: 'center', position: 'relative', zIndex: 2 }}>
        ...
        <Reveal delay={0.08}>
          ...
          >{/* TEXTE_SECTION */ clientText(sessionData, "financement.titre") ?? (<>
      ...
      <div style={{ maxWidth: 1260, margin: '0 auto', position: 'relative', zIndex: 2 }}>
        <div style={{ maxWidth: 680, marginBottom: 64 }}>
          ...
          <Reveal delay={0.08}>
            ...
            >{/* TEXTE_SECTION */ clientText(sessionData, "techno.titre") ?? (<>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            >
              ...
              {clientAddress(sessionData) ?? "12 rue Notre-Dame, 33000 Bordeaux Chartrons"}
            </div>
            <div
              style={{
                display: 'flex',
      ...
      >
        <Reveal>
          ...
          >
            ...
            <GoldButton filled>
              <a href={`tel:${(clientPhone(sessionData) ?? clientEmail(sessionData) ?? fd?.email ?? "+33556215858").replace(/[^+0-9]/g, "")}`} style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center', gap: 8 }}>
                Appeler maintenant
              </a>
            </GoldButton>
          </div>
