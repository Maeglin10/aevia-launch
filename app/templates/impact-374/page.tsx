...
const SERVICES_DEMO = [{"titre": "Transport médical assis (TAP)", "desc": "Dialyses, chimiothérapies, consultations : conventionné Assurance Maladie — sur prescription médicale de transport, vous n'avancez rien.", "tag": "Médical"}, {"titre": "Abonnements réguliers", "desc": "Les mêmes trajets chaque semaine : travail, kiné, école de musique des enfants. Le même chauffeur, l'horaire garanti, la facture mensuelle.", "tag": "Réguliers"}, {"titre": "Gares & aéroport", "desc": "Rennes en TGV part tôt : prises en charge dès 6 h, bagages portés, dépose au plus près du quai.", "tag": "Gares"}, {"titre": "Aînés & mobilité douce", "desc": "Aide à la montée, accompagnement jusqu'à la salle d'attente, patience véritable : le trajet fait partie du soin.", "tag": "Aînés"}, {"titre": "Enfants & ados", "desc": "Conservatoire, sport, garde alternée : des trajets confiés au même chauffeur connu des parents — avec SMS d'arrivée.", "tag": "Familles"}, {"titre": "Courses ponctuelles", "desc": "Un dîner, un rendez-vous, une voiture au garage : le VTC classique, au prix annoncé avant de monter.", "tag": "Ponctuel"}];
...
const STATS = [{"value": "TAP", "label": "Transport médical assis conventionné"}, {"value": "6h", "label": "Premières prises en charge"}, {"value": "180+", "label": "Abonnés réguliers"}, {"value": "100 %", "label": "De courses confirmées la veille"}];
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          {fd?.logoBase64 ? (
            ...
            <>
              ...
              <span style={{ fontFamily: FONT, fontSize: 18, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{fd?.businessName ?? "Cap Chauffeur"}</span>
...
<section className="i374-hero" style={{ minHeight: "100dvh", display: "grid", gridTemplateColumns: "minmax(0,1.08fr) minmax(0,0.92fr)", gap: 56, alignItems: "center", padding: "140px 64px 70px", maxWidth: 1260, margin: "0 auto" }}><DifferentialExit depth={0.15}>
        <div>
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.85, ease: [0.16, 1, 0.3, 1] }} style={{ fontFamily: FONT, fontSize: "clamp(34px, 4.6vw, 60px)", color: C.text, lineHeight: 1.1, margin: "18px 0 20px" }}>
            {c?.heroHeadline ?? (<>Le chauffeur des jours<br /><em style={{ color: C.accentDark }}>où ça compte.</em></>)}
          </motion.h1>
          <motion.p initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }} style={{ fontSize: 16.5, color: C.textMuted, lineHeight: 1.75, maxWidth: 480, marginBottom: 32 }}>
            {c?.heroSubline ?? fd?.tagline ?? "Rendez-vous médicaux, gares matinales, enfants à récupérer, parents à véhiculer : un VTC de confiance pour les trajets de la vraie vie — dont le transport médical assis conventionné."}
          </motion.p>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <Reveal>
            <div style={{ marginBottom: 50 }}>
              <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: 4, textTransform: "uppercase", color: C.accentDark }}>Services</span>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 16 }}>
              ...
              <h2 style={{ fontFamily: FONT, fontSize: "clamp(28px, 3.5vw, 44px)", color: C.text, marginTop: 10 }}>Prévus, <em>pas subis.</em></h2>
      ...
      <section className="i374-pad" style={{ padding: "96px 64px", background: C.bgDark }}>
        <Reveal>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontFamily: FONT, fontSize: "clamp(26px, 3.4vw, 42px)", color: "#fff" }}>Des habitudes <em style={{ color: C.hi }}>bien accompagnées</em>.</h2>
          </div>
        </Reveal>
      ...
      <footer className="i374-pad" style={{ background: C.bgDark, padding: "44px 64px 22px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 28, marginBottom: 30 }}>
            <div>
              <div style={{ fontFamily: FONT, fontSize: 18, color: C.hi, marginBottom: 8 }}>{fd?.businessName ?? "Cap Chauffeur"}</div>
              <p style={{ color: "rgba(255,255,255,0.38)", fontSize: 13, lineHeight: 1.7 }}>VTC & transport assis · Rennes<br />REVTC — conventionné transport assis professionnalisé (TAP)</p>
            </div>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Cap Chauffeur"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
