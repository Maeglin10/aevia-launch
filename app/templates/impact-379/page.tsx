...
const HERO = [{"k": "Mobilier contemporain", "line": "Le meuble dessiné pour votre mur, pas pour un catalogue.", "sub": "Noyer, frêne olivier, chêne de pays — massif uniquement.", "img": "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80", "alt": "Meuble en bois massif à l'atelier"}, {"k": "Restauration", "line": "Rendre à un meuble ce que le temps lui a pris.", "sub": "Placages, colle d'os, vernis au tampon, serrures d'origine.", "img": "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=800&q=80", "alt": "Établi et outils de l'ébéniste"}, {"k": "Marqueterie", "line": "Le dessin fait de bois, pièce par pièce.", "sub": "Motifs contemporains ou reprises de modèles anciens.", "img": "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80", "alt": "Intérieur meublé de pièces d'ébénisterie"}];
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          {fd?.logoBase64 ? (
            ...
            <>
              ...
              <span style={{ fontFamily: FONT, fontSize: 18, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{fd?.businessName ?? "Établi Moreau"}</span>
...
<section className="i379-hero" style={{ minHeight: "100dvh", display: "grid", gridTemplateColumns: "minmax(0,1.08fr) minmax(0,0.92fr)", gap: 56, alignItems: "center", padding: "140px 64px 70px", maxWidth: 1260, margin: "0 auto" }}>
      ...
      <section id="engagements" className="i379-pad" style={{ padding: "96px 64px", background: C.bgSection }}>
        <div className="i379-split" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 64, alignItems: "center" }}>
          <Reveal>
            <img src={photo(3, "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=800&q=80")} alt="L'établi de l'ébéniste" loading="lazy" style={{ width: "100%", borderRadius: 10, aspectRatio: "4/3", objectFit: "cover" }} />
          </Reveal>
          <Reveal delay={0.15}>
            <div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Établi Moreau"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
