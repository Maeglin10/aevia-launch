  ...
  return (
    <div className="bg-[#0a0c10] text-[#a0a0a0] min-h-screen pb-24">
      <section className="py-20 max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-16 font-sans text-sm text-white/40 leading-relaxed mt-20">
          <Reveal delay={0.1}>
            <div>
              <h3 className="text-lg font-bold uppercase tracking-widest text-[#c9a96e] mb-6 italic">
                1. Éditeur du site
              </h3>
