...
return (
    <div className="bg-[#0a0c10] text-[#a0a0a0]">
        ...
        <section className="py-60 bg-[#0a0c10] relative overflow-hidden">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
              ...
              <div>
                <Reveal>
                  <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-[var(--brand,#c9a96e)] block mb-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    {[
                      ...
                      <div key={i} className="group">
                        <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[var(--brand,#c9a96e)] group-hover:text-black transition-all">
                  ...
                  <Link href="/templates/impact-60/collections" className="group cursor-pointer block" style={{ textDecoration: "none" }}>
                    <div className="aspect-[4/5] relative mb-12 overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-1000 border border-white/5 p-2 bg-white/[0.02]">
                      ...
                      <div className="absolute bottom-10 left-10">
                        <div className="text-[10px] font-bold uppercase tracking-widest text-[var(--brand,#c9a96e)] mb-2 italic">
                          Ref: 0{i + 1} — ZENITH
                        </div>
              ...
              {TESTIMONIALS_LIST.map((t, i) => (
                <Reveal key={i} delay={i * 0.12}>
                  <div className="bg-[#0a0c10] p-14 flex flex-col gap-8 group hover:bg-black transition-colors">
                    <div className="text-6xl text-[var(--brand,#c9a96e)]/10 font-serif leading-none">&ldquo;</div>
                    ...
                    <div className="border-t border-white/5 pt-8">
                      ...
                      <div className="text-[10px] text-[var(--brand,#c9a96e)] font-mono tracking-widest mt-2">{t.origin}</div>
                    </div>
                  </div>
                </Reveal>
              ))}
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div key={i} className="flex gap-8 group">
                      <div className="w-16 h-16 shrink-0 border border-[var(--brand,#c9a96e)]/20 flex items-center justify-center group-hover:bg-[var(--brand,#c9a96e)] group-hover:border-[var(--brand,#c9a96e)] transition-all duration-700">
                        <f.icon className="w-5 h-5 text-[var(--brand,#c9a96e)]/60 group-hover:text-black transition-colors" />
                      </div>
                      <div>
      ...
      <footer style={{ padding: "40px 24px", textAlign: "center", fontSize: 13, letterSpacing: "0.08em", opacity: 0.9, textShadow: "0 0 2px rgba(0,0,0,0.55), 0 0 10px rgba(255,255,255,0.35)" }}>
        {clientName(sessionData) ?? "Zenith Watch"}
