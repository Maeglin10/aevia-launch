...
export default function IvoryArchivePremium() {
  ...
  useEffect(() => {
    ...
    let n = 2;
    const _photoArrays: any[] = [COLLECTIONS, ARCHIVE_WORKS, JOURNAL];
      ...
      <main>
        ...
        <section className="relative h-dvh flex items-center justify-center overflow-hidden">
          <motion.div style={{ opacity: heroOpacity, scale: heroScale }} className="absolute inset-0 z-0">
             <Image
                src={photo(10, "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=1600&q=80")}
           ...
           <div className="max-w-[1400px] mx-auto px-8 md:px-20">
              <div className="grid lg:grid-cols-2 gap-32 items-center">
                 <div className="relative aspect-[4/5] overflow-hidden group">
                    <Image
                       src={photo(11, "https://images.unsplash.com/photo-1504275107627-0c2ba7a43dba?q=80&w=1200&auto=format&fit=crop")}
