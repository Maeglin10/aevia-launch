    ...
    <section id="hero" ref={ref} style={section}>
      ...
      >
        ...
        >
          ...
          <a href="tel:0240000000" style={{ textDecoration: 'none' }}>
            <GreenButton>
              <Phone size={15} />
              02 40 00 00 00
            </GreenButton>
...
function ScrollCrossfade() {
  ...
  return (
    <section
      ref={ref}
      style={{ height: '320vh', position: 'relative', background: C.navyDeep }}
    >
      <div
        style={{
          position: 'sticky',
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <a
                href="mailto:contact@ampere-fils.fr"
                style={{
                  fontFamily: SANS,
                  fontSize: 13,
                  color: C.green,
