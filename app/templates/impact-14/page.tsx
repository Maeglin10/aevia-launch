...
const globalStyles = `
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .gold-shimmer {
    background: linear-gradient(90deg, var(--brand,#c9a84c) 0%, #f0d98c 40%, var(--brand,#c9a84c) 60%, #a07828 100%);
  ...
  .timeline-line::after {
    ...
    background: linear-gradient(to bottom, var(--brand,#c9a84c), transparent);
  ...
  .compass-petal {
    ...
    background: linear-gradient(to top, var(--brand,#c9a84c), transparent);
  }
            ...
            <div
              ...
              style={{
                ...
                background: isCardinal
                  ? "linear-gradient(to bottom, var(--brand,#c9a84c), rgba(201,168,76,0.1))"
    ...
    >
      ...
      <div
        style={{
          ...
          right: 0,
          height: 2,
          background: "linear-gradient(90deg, transparent, var(--brand,#c9a84c), transparent)",
      ...
      >
        {[80, 160, 240, 320].map((x) => (
          <line key={x} x1={x} y1="0" x2={x} y2="380" stroke="var(--brand,#c9a84c)" strokeWidth="0.5" />
        ))}
        {[95, 190, 285].map((y) => (
          <line key={y} x1="0" y1={y} x2="400" y2={y} stroke="var(--brand,#c9a84c)" strokeWidth="0.5" />
        ))}
      </svg>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background: isActive ? "var(--brand,#c9a84c)" : "rgba(201,168,76,0.2)",
            border: `2px solid ${isActive ? "var(--brand,#c9a84c)" : "rgba(201,168,76,0.3)"}`,
        ...
        {index < voyageWaypoints.length - 1 && (
          <div
            style={{
              ...
              minHeight: 60,
              background: isActive
                ? "linear-gradient(to bottom, var(--brand,#c9a84c), rgba(201,168,76,0.2))"
                : "rgba(201,168,76,0.1)",
              marginTop: 4,
    ...
    >
      ...
      <motion.div
        style={{
          ...
          right: 0,
          height: 1,
          background: "linear-gradient(90deg, var(--brand,#c9a84c), #f0d98c)",
            ...
            {fd?.logoBase64 ? (
              ...
              <>
                ...
                >
                  <Anchor
                    size={14}
                    style={{color: brand ?? 'var(--brand,#c9a84c)', transform: "rotate(-45deg)" }}
                  />
                </div>
                <div>
                  <p
            ...
            {[
              ...
              <a
                ...
                style={{
                  ...
                  fontSize: 11,
                  fontWeight: 500,
                  color: page === item.page ? "var(--brand,#c9a84c)" : "rgba(240,236,224,0.7)",
                  textDecoration: "none",
                  letterSpacing: 2,
                  textTransform: "uppercase",
                ...
                onMouseEnter={(e) =>
                  ((e.target as HTMLAnchorElement).style.color = "var(--brand,#c9a84c)")
                }
                onMouseLeave={(e) =>
                  ((e.target as HTMLAnchorElement).style.color =
                    page === item.page ? "var(--brand,#c9a84c)" : "rgba(240,236,224,0.7)")
                }
              >
                {item.name}
              </a>
          ...
          >
            <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: "3rem" }}>
              <button
                ...
                style={{background: "none", border: "none", color: brand ?? 'var(--brand,#c9a84c)', cursor: "pointer" }}
              >
                <X size={24} />
              </button>
            </div>
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    fontSize: "2.5rem",
                    fontWeight: 300,
                    color: page === item.page ? "var(--brand,#c9a84c)" : "#f0ece0",
                    textDecoration: "none",
                    marginBottom: "1.5rem",
                    letterSpacing: 2,
                  }}
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
              <div style={{width: 40, height: 1, background: brand ?? 'var(--brand,#c9a84c)' }} />
              <p
                style={{fontFamily: "Montserrat, sans-serif",
                  fontSize: 10,
                  fontWeight: 500,
        ...
        >
          ...
          <div style={{ animation: "scrollBounce 2s ease-in-out infinite" }}>
            <ChevronDown size={16} style={{color: brand ?? 'var(--brand,#c9a84c)' }} />
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          {Array.from({ length: 20 }, (_, i) => (
            <line key={`v${i}`} x1={i * 64} y1="0" x2={i * 64} y2="600" stroke="var(--brand,#c9a84c)" strokeWidth="0.5" />
          ))}
          {Array.from({ length: 10 }, (_, i) => (
            <line key={`h${i}`} x1="0" y1={i * 60} x2="1280" y2={i * 60} stroke="var(--brand,#c9a84c)" strokeWidth="0.5" />
          ))}
        </svg>
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 4, marginBottom: "2rem" }}>
                {Array.from({ length: testimonials[activeTestimonial].stars }, (_, i) => (
                  <Star key={i} size={14} style={{color: brand ?? 'var(--brand,#c9a84c)', fill: "var(--brand,#c9a84c)" }} />
                ))}
              </div>
              ...
              <div style={{ borderTop: "1px solid rgba(201,168,76,0.15)", paddingTop: "1.5rem" }}>
                ...
                <p style={{fontFamily: "Montserrat, sans-serif", fontSize: 10, color: brand ?? 'var(--brand,#c9a84c)', letterSpacing: 2, marginTop: 4 }}>
            ...
            {testimonials.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 2,
                  background: i === activeTestimonial ? "var(--brand,#c9a84c)" : "rgba(201,168,76,0.3)",
                  border: "none",
                  cursor: "pointer",
                  transition: "all 0.4s ease",
                }}
              ...
              <div style={{ marginBottom: "1.5rem" }}>
                ...
                <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
                  {/* LISTE_LIBELLES */ (clientList(sessionData, "bloc.liste2") ?? ["Motor Yacht", "Sailing Yacht", "Catamaran", "Explorer Yacht", "No Preference"]).map((type) => (
                    ...
                    >
                      <input type="radio" name="vesselType" style={{accentColor: brand ?? 'var(--brand,#c9a84c)' }} />
                      {type}
                    </label>
                  ))}
                </div>
          ...
          >
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.5rem" }}>
                ...
                >
                  <Anchor size={14} style={{color: brand ?? 'var(--brand,#c9a84c)', transform: "rotate(-45deg)" }} />
                </div>
                <div>
  ...
  const fleetYachts = /* REALISATIONS */ resolveList(clientWorks(sessionData)?.map((o: any) => ({ name: o.title, type: o.detail || undefined, ...(o.imageUrl ? { img: o.imageUrl } : {}), desc: o.desc || "" })), [
    {
      ...
      speed: "16 knots",
      price: "€380,000",
      img: photo(0, (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?auto=format&fit=crop&q=80&w=1200")),
    ...
    },
    {
      ...
      speed: "12 knots",
      price: "€160,000",
      img: photo(1, (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?auto=format&fit=crop&q=80&w=1200")),
    ...
    },
    {
      ...
      speed: "18 knots",
      price: "€650,000",
      img: photo(2, (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&q=80&w=1200")),
    ...
    },
    {
      ...
      speed: "15 knots",
      price: "€800,000",
      img: photo(3, (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?auto=format&fit=crop&q=80&w=1200")),
          ...
          {(["all", "motor", "sailing", "explorer"] as const).map((t) => (
            <button
              ...
              style={{
                ...
                fontSize: 10,
                fontWeight: 600,
                color: filter === t ? "#0d1b2a" : "var(--brand,#c9a84c)",
                background: filter === t ? "var(--brand,#c9a84c)" : "transparent",
                border: "1px solid rgba(201,168,76,0.3)",
...
function DestinationsPage({ goTo }: { goTo: (p: ActivePage) => void }) {
  const allDestinations = resolveList(
    clientServices({ formData: fd, businessProfile: bp, generatedContent: c })?.map((s: any, i: number) => ({ ...([
    {
      ...
      yacht: "M/Y Lumière",
      img: photo(5, (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&q=80&w=1200")),
    },
    {
      ...
      yacht: "S/Y Ariel",
      img: photo(6, (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?auto=format&fit=crop&q=80&w=1200")),
    },
    {
      ...
      yacht: "M/Y Odyssey",
      img: photo(7, (clientPhotos(sessionData)[7] || "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&q=80&w=1200")),
    },
    {
      ...
      bestTime: "May — September",
      yacht: "M/Y Étoile",
      img: photo(8, (clientPhotos(sessionData)[8] || "https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&q=80&w=1200")),
    },
    {
      ...
      yacht: "S/Y Chronos",
      img: photo(9, (clientPhotos(sessionData)[9] || "https://images.unsplash.com/photo-1548574505-5e239809ee19?auto=format&fit=crop&q=80&w=1200")),
    },
    {
      ...
      yacht: "M/Y Odyssey",
      img: photo(10, (clientPhotos(sessionData)[10] || "https://images.unsplash.com/photo-1517760444937-f6397edcbbcd?auto=format&fit=crop&q=80&w=1200")),
    },
  ])[i % ([
    {
      name: "Monaco & French Riviera",
        ...
        <div className="imx-mobstack" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "4rem", flexWrap: "wrap", alignItems: "flex-start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
            ...
            {offices.map((off) => (
              ...
              >
                <h4 style={{fontFamily: "Montserrat, sans-serif", fontSize: 14, fontWeight: 600, color: brand ?? 'var(--brand,#c9a84c)', textTransform: "uppercase", letterSpacing: 2, marginBottom: "0.5rem" }}>
                  {off.city}
                </h4>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  ...
                  <span style={{fontFamily: "Montserrat, sans-serif", fontSize: 11, color: brand ?? 'var(--brand,#c9a84c)' }}>
                    Email: {off.email}
                  </span>
                </div>
              </div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", fontFamily: "Montserrat, sans-serif" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem", fontSize: "0.9rem", color: "rgba(240,236,224,0.7)", lineHeight: 1.8, fontWeight: 300 }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(201,168,76,0.15)", padding: "2rem", borderRadius: 4 }}>
            <h3 style={{fontFamily: "Cormorant Garamond, Georgia, serif", fontSize: "1.4rem", color: brand ?? 'var(--brand,#c9a84c)', marginBottom: "1rem", fontWeight: 400 }}>
