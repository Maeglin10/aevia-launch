...
const HERO = [
  { k: "Grandir dehors", sub: "Le jardin n'est pas une option météo.", tiles: [{ icon: TreePine, t: "Dehors tous les jours", d: "Combinaisons de pluie fournies — il n'y a pas de mauvais temps.", bg: "#d9ecea", fg: "#135e57" }, { icon: Blocks, t: "Motricité libre", d: "Au sol, pieds nus, à son rythme : on ne met pas assis un bébé qui ne s'assoit pas.", bg: "#0f2523", fg: "#d9ecea" }, { icon: Baby, t: "Référente par enfant", d: "Une professionnelle repère pour chaque enfant, du premier au dernier jour.", bg: "#e9f2f1", fg: "#135e57" }] },
  { k: "Bien manger", sub: "La cuisine est dans la crèche, pas dans un camion.", tiles: [{ icon: Soup, t: "Cuisiné sur place", d: "Repas bio du jour, adaptés à chaque âge et chaque allergie.", bg: "#0f2523", fg: "#d9ecea" }, { icon: Baby, t: "Diversification menée", d: "Introduction des aliments coordonnée avec vous, jamais imposée.", bg: "#d9ecea", fg: "#135e57" }, { icon: TreePine, t: "Potager des petits", d: "Les tomates cerises qu'on a plantées ont un autre goût.", bg: "#e9f2f1", fg: "#135e57" }] },
  { k: "S'éveiller", sub: "Peu d'écrans zéro, beaucoup de vrais objets.", tiles: [{ icon: Music4, t: "Éveil musical", d: "Une intervenante chaque semaine, des instruments à toucher.", bg: "#e9f2f1", fg: "#135e57" }, { icon: BookOpen, t: "Livres partout", d: "Lecture libre et racontées du matin — la bibliothèque est au sol.", bg: "#d9ecea", fg: "#135e57" }, { icon: Blocks, t: "Jeu libre d'abord", d: "Le programme, c'est le leur : on prépare l'environnement, ils font le reste.", bg: "#0f2523", fg: "#d9ecea" }] }
];
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          {fd?.logoBase64 ? (
            ...
            <>
              ...
              <span style={{ fontFamily: FONT, fontSize: 18, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{fd?.businessName ?? "Les Petits Cairns"}</span>
...
<section className="i353-hero" style={{ minHeight: "100dvh", display: "grid", gridTemplateColumns: "minmax(0,1.08fr) minmax(0,0.92fr)", gap: 56, alignItems: "center", padding: "140px 64px 70px", maxWidth: 1260, margin: "0 auto" }}>
      ...
      <section id="engagements" className="i353-pad" style={{ padding: "96px 64px", background: C.bgSection }}>
        <div className="i353-split" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 64, alignItems: "center" }}>
          <Reveal>
            <div style={{ borderRadius: 12, border: `1px solid ${C.border}`, background: C.accentLight, aspectRatio: "4/3", justifyContent: "center" , overflow: "hidden" }}><img src={photo(0, "https://images.pexels.com/photos/8422255/pexels-photo-8422255.jpeg?auto=compress&cs=tinysrgb&w=1400")} alt="Temps de jeu à la micro-crèche" loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} /></div>
          </Reveal>
          <Reveal delay={0.15}>
            <div>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 16 }}>
              ...
              <h2 style={{ fontFamily: FONT, fontSize: "clamp(28px, 3.5vw, 44px)", color: C.text, marginTop: 10 }}>Moins cher <em>qu'on ne le croit.</em></h2>
      ...
      <section className="i353-pad" style={{ padding: "96px 64px", background: C.bgDark }}>
        <Reveal>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontFamily: FONT, fontSize: "clamp(26px, 3.4vw, 42px)", color: "#fff" }}>Des parents <em style={{ color: C.hi }}>tranquilles</em>.</h2>
          </div>
        </Reveal>
      ...
      <footer className="i353-pad" style={{ background: C.bgDark, padding: "44px 64px 22px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 28, marginBottom: 30 }}>
            <div>
              <div style={{ fontFamily: FONT, fontSize: 18, color: C.hi, marginBottom: 8 }}>{fd?.businessName ?? "Les Petits Cairns"}</div>
              <p style={{ color: "rgba(255,255,255,0.38)", fontSize: 13, lineHeight: 1.7 }}>Micro-crèche (12 places) · Grenoble<br />Agrément PMI Isère — équipe diplômée petite enfance</p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {[{ icon: <MapPin size={13} />, t: "Grenoble, Isère" }, { icon: <Phone size={13} />, t: phone }, { icon: <Clock size={13} />, t: "Lun–Ven 7h30–18h30" }].map((item, idx) => (
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Les Petits Cairns"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
