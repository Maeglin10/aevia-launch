                  ...
                  <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-4">
                     <Reveal delay={0.2} scale={0.9}>
                        <div onClick={() => goTo("atelier")} className="aspect-[4/5] bg-zinc-900 border border-white/5 relative overflow-hidden group cursor-pointer">
                           <img src={photo(3, "https://images.unsplash.com/photo-1590362891991-f776e747a588?w=800&q=80")} className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:scale-110 transition-all duration-1000" alt="Material" />
                     ...
                     <Reveal delay={0.4} scale={0.9} y={100}>
                        <div onClick={() => goTo("atelier")} className="aspect-[4/5] bg-zinc-900 border border-white/5 relative overflow-hidden group mt-12 cursor-pointer">
                           <img src={photo(4, "https://images.unsplash.com/photo-1542282088-fe8426682b8f?w=800&q=80")} className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:scale-110 transition-all duration-1000" alt="Interior" />
                           <div className="absolute inset-0 flex items-end p-8 bg-gradient-to-t from-black/80 to-transparent">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border border-white/5 bg-zinc-950 p-12 flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2 aspect-video relative">
            <img src={photo(5, "https://images.unsplash.com/photo-1611605645802-c21be743c321?w=800&q=80")} alt="Aerodynamics tunnel" className="w-full h-full object-cover grayscale" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div className="aspect-[4/5] bg-zinc-900 border border-white/5 relative overflow-hidden">
            <img src={photo(6, "https://images.unsplash.com/photo-1590362891991-f776e747a588?w=800&q=80")} alt="Design sketch" className="w-full h-full object-cover grayscale opacity-50" />
