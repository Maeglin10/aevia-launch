...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  fr: {
    "appelez, on organise.": "Appelez, nous organisons.",
  },
  es: {
    ...
    "appelez, on organise.": "Llama, organizamos.",
  },
  de: {
    ...
    "appelez, on organise.": "Rufen Sie an, wir organisieren.",
  },
  pt: {
    ...
    "collection": "Coleção",
    "appelez, on organise.": "Ligue, nós organizamos.",
  },
};
