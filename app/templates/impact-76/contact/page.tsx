      ...
      <div className="max-w-[1000px] mx-auto px-6">
        <Reveal className="text-center mb-16">
          ...
          <p className="text-sm text-white/40 max-w-md mx-auto uppercase tracking-widest leading-relaxed mt-4">
            Begin the generative architectural review. Specify details about your volumetric and site targets.
          </p>
        </Reveal>

        <Reveal>
          <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl">
            {formSubmitted ? (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full bg-[#0a0a0c] border border-white/5 rounded-none px-6 py-4 text-xs font-bold outline-none focus:border-stone-500 text-white transition-all uppercase tracking-widest">
                    <option value="residential">Residential // Villa Aether</option>
                    <option value="commercial">Commercial // Kinetic Tower</option>
                    <option value="cultural">Cultural // Void Studio</option>
                  </select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    required
                    rows={5}
                    placeholder="Describe your site geography, desired volume metrics, structural parameters..."
                    className="w-full bg-white/[0.02] border border-white/5 rounded-none px-6 py-4 text-xs font-bold outline-none focus:border-stone-500 text-white transition-all uppercase tracking-widest"
                  />
                </div>
                ...
                <div className="flex justify-between items-center pt-4 border-t border-white/5">
                  <div className="flex items-center gap-2 text-[9px] font-bold text-white/20 uppercase tracking-widest">
                    <Terminal className="w-3.5 h-3.5" /> SECURE_UPLINK_0x76
                  </div>
                  <MagneticBtn
                    type="submit"
                  ...
                  >
                    Transmit_Manifesto <Send className="w-3.5 h-3.5" />
                  </MagneticBtn>
                </div>
              </form>
            )}
