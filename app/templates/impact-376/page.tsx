...
const ENGAGEMENT = ["Notes de calcul fournies pour chaque ouvrage structurel — pas de verre « au jugé »", "Garantie décennale, verres certifiés, DTU 39 respecté et documenté", "Un interlocuteur unique du premier trait à la réception", "Showroom sur rendez-vous : touchez les verres, comparez les profils"];
...
const STATS = [{"value": "120+", "label": "Projets d'architectes livrés"}, {"value": "DTU 39", "label": "Calculs et conformité vitrage"}, {"value": "10 ans", "label": "Décennale sur les ouvrages"}, {"value": "3D", "label": "Chaque projet modélisé avant"}];
...
export default function VerreEtLumierePage() {
  ...
  const phone = fd?.phone ?? "03 89 00 00 00";
  const telHref = `tel:${fd?.phone ?? "+33389000000"}`;
  const mail = fd?.email ?? "projets@verre-et-lumiere.fr";
    ...
    <div style={{ background: C.bg, color: C.text, fontFamily: FONT_BODY, overflowX: "clip" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          {fd?.logoBase64 ? (
            ...
            <>
              ...
              <span style={{ fontFamily: FONT, fontSize: 18, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{fd?.businessName ?? "Verre & Lumière"}</span>
      ...
      <section className="i376-hero" style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", justifyContent: "center", padding: "140px 64px 70px", maxWidth: 1080, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 16.5, color: C.textMuted, lineHeight: 1.75, maxWidth: 560, margin: "14px 0 32px" }}>
          {c?.heroSubline ?? fd?.tagline ?? "Verrières d'atelier, garde-corps, planchers et marches de verre, cloisons toute hauteur : la miroiterie qui travaille avec les architectes — calculs, DTU et poésie de la lumière compris."}
        </p>
      ...
      <section id="engagements" className="i376-pad" style={{ padding: "96px 64px", background: C.bgSection }}>
        <div className="i376-split" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 64, alignItems: "center" }}>
          <Reveal>
            <div style={{ borderRadius: 12, border: `1px solid ${C.border}`, background: C.accentLight, aspectRatio: "4/3", justifyContent: "center" , overflow: "hidden" }}><img src={photo(0, "https://images.pexels.com/photos/7031840/pexels-photo-7031840.jpeg?auto=compress&cs=tinysrgb&w=1400")} alt="Paroi de verre sur mesure" loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} /></div>
          </Reveal>
          <Reveal delay={0.15}>
            <div>
      ...
      <footer className="i376-pad" style={{ background: C.bgDark, padding: "44px 64px 22px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 28, marginBottom: 30 }}>
            <div>
              <div style={{ fontFamily: FONT, fontSize: 18, color: C.hi, marginBottom: 8 }}>{fd?.businessName ?? "Verre & Lumière"}</div>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Verre & Lumière"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
