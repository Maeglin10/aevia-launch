...
function TESTIMONIALS_SOURCE_LIVE() {
  ...
  { quote: '"J\'habite en banlieue de ' + (clientCity(sessionData) ?? 'Bordeaux') + ' et le ' + clientNameOr('Lumyx') + ' ONE couvre mes 18 km de trajet chaque jour sans sourciller. La charge rapide le soir en 3h30, c\'est parfait pour mon rythme."', name: 'Sophie L.', city: (clientCity(sessionData) ?? 'Bordeaux') + ', 33', stars: 5 },
