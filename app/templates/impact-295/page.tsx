...
let C: Record<string, string> = {
  primary: "var(--brand,#c0111f)",
  primaryLight: "var(--brand-light,#e02030)",
  primaryDark: "#8c0d17",
  bg: "#1a1a1a",
  bgDeep: "#0d0d0d",
  bgCard: "#242424",
...
return (
    <div style={{
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Noto+Serif+JP:wght@400;500;600;700;900&family=DM+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&display=swap');
      `}</style>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <a href="#hero" style={{
            ...
            fd?.businessName ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Wok Master"))
          )}</a>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? clientEmail(sessionData) ?? fd?.email ?? "+33523722265").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>+33 (0)5 00 00 00 00</a>
                    </div>
                  </div>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            © {new Date().getFullYear()} {clientName(sessionData) ?? "Wok Master."} Tous droits réservés.{/* VILLE_PIED */}{clientCity(sessionData) ? ` · ${clientCity(sessionData)}` : ""}
          </div>
        </div>
      </footer>
