      ...
      <nav style={{
        ...
        <div style={{
          ...
          <a href="#hero" style={{
            ...
            fd?.businessName ?? (clientName(sessionData) ?? "Wok Master")
          )}</a>
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{fd?.businessName ?? (clientName(sessionData) ?? "Wok Master")}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <h4 style={{ fontFamily: SERIF, fontSize: 18, color: C.primary, marginBottom: 16, fontWeight: 700 }}>{fd?.businessName ?? (clientName(sessionData) ?? "Wok Master")}</h4>
