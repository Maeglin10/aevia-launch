...
const PHOTO = {
  ...
  gallery1: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=800&auto=format&fit=crop",
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "8h", "label": "Mijotage Bouillons"}, {"value": "Daily", "label": "Poisson de Rungis"}, {"value": "25 min", "label": "Livraison Moyenne"}].map((stat, i) => (
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{fd?.businessName ?? "Wok Master"}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Choix wok ou sushi + soupe miso + dessert à 13,50€. Disponible 11h30–14h30.
            </p>
          </Reveal>
      ...
      <section id="faq" style={{ padding: '120px 24px', background: C.bgDeep }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[{"q":"Quels sont vos délais de livraison ?","a":"En moyenne 30 minutes via notre flotte locale de livreurs électriques dans Paris 13e, 14e, et 5e arrondissements."},{"q":"Proposez-vous des bouillons sans porc ?","a":"Oui, notre Shoyu Ramen est composé d'un bouillon de poule clair et de champignons shiitaké japonais."},{"q":"Peut-on personnaliser son wok ?","a":"Absolument. Choisissez vos nouilles ou riz, vos protéines (poulet, bœuf, crevettes, tofu), vos légumes et votre sauce."}].map((item, i) => (
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <h4 style={{ fontFamily: SERIF, fontSize: 18, color: C.primary, marginBottom: 16, fontWeight: 700 }}>{fd?.businessName ?? "Wok Master"}</h4>
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                Lun–Sam 11h30–22h · Dim 12h–21h30
              </p>
            </div>
          ...
          <div style={{
            ...
            © {new Date().getFullYear()} Wok Master. Tous droits réservés.
          </div>
        </div>
      </footer>
