...
function PROJECTS_DEMO_LIVE() {
  return /* RÉALISATIONS */ resolveList(clientWorks(sessionData)?.map((o: any) => ({ title: o.title, type: o.detail || undefined, ...(o.imageUrl ? { img: o.imageUrl } : {}), desc: o.desc || "" })), [
  ...
  { title: "Bureau Lumière", type: "Commercial", img: (clientPhotos(sessionData)[2] || "https://images.pexels.com/photos/26747978/pexels-photo-26747978.jpeg?auto=compress&cs=tinysrgb&w=1600"), desc: "Biophilic office redesign for a tech company prioritizing employee wellbeing." },
]);
}
...
export default function AtelierInteriorPage() {
  ...
  return (
    <div className="bg-[#f5f0eb] text-[#2a2520] font-sans min-h-dvh selection:bg-[var(--brand,#8b7355)] selection:text-white overflow-x-hidden">
      ...
      {/* ── NAVBAR ─────────────── */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${scrolled ? "bg-[#f5f0eb]/90 backdrop-blur-xl border-b border-[var(--brand,#8b7355)]/10 py-4" : "bg-gradient-to-b from-black/72 via-black/48 to-transparent lg:bg-gradient-to-b lg:from-[#2a2520]/70 lg:via-[#2a2520]/58 lg:to-transparent py-8"}`}>
      ...
      <main>
        ...
        <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <Image src={photo(4, "https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&q=80&w=2400")} alt="CTA" fill className="object-cover" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <Reveal>
                <div className="relative aspect-[4/5] overflow-hidden rounded-sm">
                  <ParallaxImg src={photo(5, "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?auto=format&fit=crop&q=80&w=1200")} alt="Atelier workspace" />
                </div>
              </Reveal>
              <div>
                <Reveal delay={0.2}>
