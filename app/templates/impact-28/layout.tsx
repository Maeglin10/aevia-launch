          ...
          {menuOpen && (
            ...
            >
              <div className="px-6 py-4 flex flex-col gap-4 text-sm font-bold uppercase tracking-widest">
                ...
                <Link href="/templates/impact-28/legal" onClick={() => setMenuOpen(false)} className="text-left py-2 hover:ml-2 transition-all cursor-pointer">Legal</Link>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <footer className="bg-black text-white py-12 px-6 border-t-4 border-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-8 text-xs font-bold uppercase tracking-widest text-white/40">
            ...
            <Link href="/templates/impact-28/legal" className="hover:text-white transition-colors cursor-pointer">Privacy & Legal</Link>
          </div>
