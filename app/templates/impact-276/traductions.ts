...
export const TRADUCTIONS: Record<string, Record<string, string>> = {
  fr: {
    "mon plan nutrition offert": "Mon plan nutrition offert",
  },
  es: {
    ...
    "mon plan nutrition offert": "Mi plan de nutrición ofrecido",
  },
  de: {
    ...
    "mon plan nutrition offert": "Mein angebotenes Ernährungsprogramm",
  },
  pt: {
    ...
    "collection": "Coleção",
    "mon plan nutrition offert": "Meu plano de nutrição oferecido",
  },
};
