...
function PHOTO_LIVE() {
  ...
  results: (clientPhotos(sessionData)[5] || 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?q=80&w=1600&auto=format&fit=crop'),
} as const;
}
      ...
      >
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px' }}>
          ...
          >
            ...
            >
              © 2025 Thomas Lebrun Coach — Bordeaux Caudéran. Tous droits réservés.{/* VILLE_PIED */}{clientCity(sessionData) ? ` · ${clientCity(sessionData)}` : ""}
            </p>
