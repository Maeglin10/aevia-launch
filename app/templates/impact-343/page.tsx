...
const STATS = [{"value": "0 %", "label": "Perchloroéthylène (aqua only)"}, {"value": "24 h", "label": "Costume rendu apprêté"}, {"value": "15 000+", "label": "Pièces traitées par an"}, {"value": "30 ans", "label": "Le même atelier, rue du Commerce"}];
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Blanc Net"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
