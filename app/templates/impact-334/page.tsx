...
const HERO = [{"k": "Façades chêne brossé", "line": "Le bois qui se patine avec la maison.", "sub": "Massif ou plaqué, huilé à cœur.", "img": "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80", "alt": "Façades bois et plan de travail"}, {"k": "Îlot central", "line": "Le point de gravité de la maison.", "sub": "Plans céramique, granit ou bois de bout.", "img": "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80", "alt": "Pièce à vivre avec agencement sur mesure"}, {"k": "De l'atelier au mur", "line": "Chaque caisson ajusté avant de partir.", "sub": "Contrôle qualité en atelier, pose en 2 jours.", "img": "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=800&q=80", "alt": "Atelier de fabrication des caissons"}];
    ...
    <div style={{ background: C.bg, color: C.text, fontFamily: FONT_BODY, overflowX: "clip" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, height: 72, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 48px", background: scrolled ? C.bg : "transparent", backdropFilter: scrolled ? "blur(12px)" : "none", borderBottom: `1px solid ${scrolled ? C.border : "transparent"}`, transition: "all 0.4s ease" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          {fd?.logoBase64 ? (
            ...
            <>
              ...
              <span style={{ fontFamily: FONT, fontSize: 18, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{fd?.businessName ?? "Studio Culina"}</span>
        ...
        <div id="i334-nav" style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <motion.a href="tel:+33450000000" style={{ background: C.accentDark, color: "#fff", borderRadius: 8, padding: "12px 22px", fontSize: 14, fontWeight: 700, textDecoration: "none", whiteSpace: "nowrap" }} whileHover={{ scale: 1.03 }}>
            Atelier conception
          </motion.a>
        </div>
      ...
      {mobileOpen && (
        <div style={{ position: "fixed", top: 72, left: 0, right: 0, zIndex: 99, background: C.bg, borderBottom: `1px solid ${C.border}`, padding: "20px 28px", display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          <a href="tel:+33450000000" style={{ background: C.accentDark, color: "#fff", borderRadius: 8, padding: "13px 22px", fontSize: 15, fontWeight: 700, textDecoration: "none", textAlign: "center", marginTop: 8 }}>Atelier conception</a>
        </div>
      )}
...
<section className="i334-hero" style={{ minHeight: "100dvh", display: "grid", gridTemplateColumns: "minmax(0,1.08fr) minmax(0,0.92fr)", gap: 56, alignItems: "center", padding: "140px 64px 70px", maxWidth: 1260, margin: "0 auto" }}>
      ...
      <section id="engagements" className="i334-pad" style={{ padding: "96px 64px", background: C.bgSection }}>
        <div className="i334-split" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 64, alignItems: "center" }}>
          <Reveal>
            <img src={photo(3, "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=800&q=80")} alt="Contrôle d'un caisson à l'atelier" loading="lazy" style={{ width: "100%", borderRadius: 10, aspectRatio: "4/3", objectFit: "cover" }} />
          </Reveal>
          <Reveal delay={0.15}>
            <div>
      ...
      <footer className="i334-pad" style={{ background: C.bgDark, padding: "44px 64px 22px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 28, marginBottom: 30 }}>
            <div>
              <div style={{ fontFamily: FONT, fontSize: 18, color: C.hi, marginBottom: 8 }}>{fd?.businessName ?? "Studio Culina"}</div>
              <p style={{ color: "rgba(255,255,255,0.38)", fontSize: 13, lineHeight: 1.7 }}>Cuisines & agencement sur mesure · Annecy<br />Fabrication européenne, pose garantie décennale</p>
            </div>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Studio Culina"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
