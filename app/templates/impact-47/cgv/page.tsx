    ...
    <div>
      ...
      <section style={{ background: C.bg, padding: "64px 24px 100px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <p style={para}>Nous livrons dans {clientCity(sessionData) ?? "Paris"} et l'Île-de-France. La livraison est offerte dans {clientCity(sessionData) ?? "Paris"} ; un supplément peut s'appliquer en Île-de-France pour les commandes ponctuelles. Les fleurs étant des produits périssables, le client veille à être disponible au créneau de livraison convenu.</p>
