    ...
    <div ref={containerRef} className="relative w-full overflow-hidden">
      ...
      <section className="min-h-dvh flex items-center relative overflow-hidden pt-20">
        ...
        <motion.div style={{ y: heroY }} className="max-w-6xl mx-auto px-6 relative w-full">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-[#00F5D4] text-xs mb-4">{clientEyebrow(sessionData) ?? "$ whoami"}</motion.div>
          <motion.h1
      ...
      <footer style={{ padding: "40px 24px", textAlign: "center", fontSize: 13, letterSpacing: "0.08em", opacity: 0.9, textShadow: "0 0 2px rgba(0,0,0,0.55), 0 0 10px rgba(255,255,255,0.35)" }}>
        {clientName(sessionData) ?? "impact-29"}
