    ...
    <div className="bg-white text-[#0f172a] overflow-x-hidden" style={{ fontFamily: "'Outfit', 'Inter', system-ui, sans-serif", ["--brand" as any]: brand ?? "#0369a1", ["--brand-light" as any]: brand ?? "#38bdf8" }}>
      ...
      <section id="hero" ref={heroRef} className="relative h-[100dvh] min-h-[640px] flex items-end overflow-hidden">
        <motion.div style={{ y: heroY }} className="absolute inset-0">
          <Image src={photo(3, "https://images.unsplash.com/photo-1572331165267-854da2b10ccc?auto=format&fit=crop&q=85&w=2400")} alt="Piscine sur-mesure" fill className="object-cover" priority style={{ filter: "brightness(0.6)" }} />
      ...
      <footer className="bg-[#060d18] pt-20 pb-10 px-6">
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {[
            ...
            { t: "Contact", ls: [(clientPhone(sessionData) ?? fd?.phone ?? "04 78 98 76 54"), (clientEmail(sessionData) ?? fd?.email ?? "contact@aquanova.fr"), "Zone Grand " + (clientCity(sessionData) ?? "Lyon"), "Étude 3D offerte", "Devis gratuit sous 48h"] },
          ].map((col, i) => (
            <div key={i}>
