      ...
      <footer className="bg-[#060d18] pt-20 pb-10 px-6">
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {[
            ...
            { t: "Contact", ls: [(clientPhone(sessionData) ?? fd?.phone ?? "04 78 98 76 54"), (fd?.email ?? "contact@aquanova.fr"), "Zone Grand " + (clientCity({ formData: fd }) ?? "Lyon"), "Étude 3D offerte", "Devis gratuit sous 48h"] },
          ].map((col, i) => (
            <div key={i}>
