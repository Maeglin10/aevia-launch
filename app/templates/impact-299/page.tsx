...
const PHOTO = {
  hero: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=1600&auto=format&fit=crop",
  about: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=1600&auto=format&fit=crop",
  special: "https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?q=80&w=1600&auto=format&fit=crop",
  gallery1: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=800&auto=format&fit=crop",
  gallery2: "https://images.unsplash.com/photo-1519824141125-994e37c7af4e?q=80&w=800&auto=format&fit=crop",
  gallery3: "https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=800&auto=format&fit=crop",
  gallery4: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800&auto=format&fit=crop"
} as const;
    ...
    <div style={{
      ...
      >
        <motion.div style={{
          ...
          <img 
            src={PHOTO.hero} 
            alt="Hero image showing KinéPro Sport Lyon core business" 
          ...
          <Reveal delay={0.1}>
            <div style={{
              ...
              <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#ffffff', fontWeight: 600 }}>
                Kinésithérapeute du sport · Lyon
              </span>
            </div>
          </Reveal>
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>KinéPro Sport Lyon</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <Reveal delay={0.15}>
              <div style={{
                ...
                {["Tous","Rehab","Trauma","Performance"].map((tab, i) => (
                  <button
                    key={i}
      ...
      <section id="faq" style={{ padding: '120px 24px', background: C.bgDeep }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[{"q":"Qu'est-ce que le Dry Needling ?","a":"C'est une technique qui utilise des aiguilles de puncture stériles très fines pour relâcher les tensions musculaires profondes (trigger points). Très efficace pour les sportifs."},{"q":"Faut-il une ordonnance pour consulter ?","a":"Pour bénéficier du remboursement de la Sécurité Sociale, une prescription médicale de kinésithérapie est obligatoire. Pour les bilans de performance, l'ordonnance n'est pas nécessaire."},{"q":"Quelles sont les modalités d'accès au plateau ?","a":"Le plateau de rééducation est accessible uniquement lors de vos séances encadrées par votre kinésithérapeute."}].map((item, i) => (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>contact@kinéprosportlyon.com</a>
                    </div>
                  </div>
