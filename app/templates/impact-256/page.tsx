...
let C: Record<string, string> = {
  ...
  bgDarkAlt: '#080602',
  bgCard: '#ffffff',
  accent: 'var(--brand,#c83820)',
  accentDark: 'var(--brand-light,#a02c18)',
  accentLight: '#f8d8d0',
  white: '#ffffff',
  ink: '#0e0a06',
  textMuted: '#3c2c20',
...
function PHOTO_LIVE() {
  ...
  outdoorEdit: (clientPhotos(sessionData)[6] || 'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?q=80&w=800&auto=format&fit=crop'),
} as const;
}
    ...
    <section style={sec}>
      ...
      <div style={grid}>
        {TESTIMONIALS.map((t, i) => (
          <Reveal key={i} delay={i * 0.13} style={{ height: '100%' }}>
            <figure
              style={{
                background: C.bgCard,
