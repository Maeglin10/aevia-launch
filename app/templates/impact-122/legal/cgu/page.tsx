...
export default function Page() {
  return (
    <div className="bg-[#fcfaf7] min-h-screen text-[#1a1814] font-sans selection:bg-white/10">
      <header className="fixed top-0 left-0 right-0 z-50 px-8 py-6 bg-black/40 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/templates/impact-122" className="flex items-center gap-2 text-xs tracking-widest uppercase hover:opacity-80 transition-opacity">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-36 pb-24">
        <h1 className="text-3xl md:text-5xl font-bold mb-6 text-[#d64000]">Conditions Générales d'Utilisation</h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed opacity-80 border-t border-white/10 pt-8">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-[#d64000]">2. Propriété intellectuelle</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-[#d64000]">3. Protection des données personnelles</h2>
