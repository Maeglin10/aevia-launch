    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          ...
          }}>{fd?.businessName ?? "Caliente Tacos"}</a>
          ...
          <Reveal delay={0.1}>
            <div style={{
              ...
              <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#ffffff', fontWeight: 600 }}>
                Mexican food · Bordeaux Victoire
              </span>
            </div>
          </Reveal>
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{fd?.businessName ?? "Caliente Tacos"}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <h4 style={{ fontFamily: SERIF, fontSize: 18, color: C.primary, marginBottom: 16, fontWeight: 700 }}>{fd?.businessName ?? "Caliente Tacos"}</h4>
