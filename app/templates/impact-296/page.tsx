...
let C: Record<string, string> = {
  primary: "var(--brand,#e8521a)",
  primaryLight: "var(--brand-light,#f06b30)",
  primaryDark: "#bf4213",
  bg: "#fffdf8",
  bgDeep: "#fff9f0",
  bgCard: "#ffffff",
...
const SERIF = "'Oswald', sans-serif" as const;
...
function PHOTO_LIVE() {
  return {
  hero: (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?q=80&w=1600&auto=format&fit=crop"),
  about: (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?q=80&w=1600&auto=format&fit=crop"),
  special: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?q=80&w=1600&auto=format&fit=crop"),
  gallery1: (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?q=80&w=800&auto=format&fit=crop"),
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1540420773420-3366772f4999?q=80&w=800&auto=format&fit=crop"),
  gallery3: (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1513584684374-8bab748fbf90?q=80&w=800&auto=format&fit=crop"),
  gallery4: (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1600271886742-f049cd451bba?q=80&w=800&auto=format&fit=crop")
} as const;
}
...
return (
    <div style={{
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Oswald:wght@300;400;500;600;700&family=Inter:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&display=swap');
      `}</style>
        ...
        <div style={{
          ...
          <Reveal delay={0.55}>
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="#contact" style={{ textDecoration: 'none' }}>
                <Button filled>Commander</Button>
              </a>
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "100%", "label": "Maïs Nixtamalisé"}, {"value": "6", "label": "Sauces Maison"}, {"value": "Daily", "label": "Avocats Frais"}].map((stat, i) => (
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              De la mild à la 🌶️🌶️🌶️ — 6 sauces préparées chaque matin sans conservateurs.
            </p>
          </Reveal>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? clientEmail(sessionData) ?? fd?.email ?? "+33524792576").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>+33 (0)5 00 00 00 00</a>
                    </div>
                  </div>
                ...
                <div style={{
                  ...
                  {formSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      ...
                      <Button type="submit" filled>Commander</Button>
                    </form>
                  )}
                </div>
              </Reveal>
