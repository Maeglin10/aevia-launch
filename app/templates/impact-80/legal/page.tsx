...
export default function LegalPage() {
  return (
    <section className="py-24 bg-[#fcfcfc] min-h-screen text-black/50 font-sans">
          ...
          <div className="space-y-12 text-sm font-light leading-relaxed">
            <div>
              ...
              <p>
                ...
                RCS: Bourg-en-Bresse
                <br />
                Physical Address: Valentin Milliand, SIREN 852 546 225, RCS Bourg-en-Bresse (adresse physique communiquée sur simple demande à contact@aevia.io)
                <br />
