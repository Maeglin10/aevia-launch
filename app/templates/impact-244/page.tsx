...
let C: Record<string, string> = {
  ...
  bgDarkAlt: '#120b07',
  bgCard: '#ffffff',
  accent: 'var(--brand,#c9826b)',
  accentDark: 'var(--brand-light,#a8644e)',
  accentLight: '#f0d8cf',
  white: '#ffffff',
  ink: '#1a0f0a',
  textMuted: '#6b4a3a',
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            Wedding Planner & Design Floral. {clientCity(sessionData) ?? "Paris"}. Chaque mariage est une histoire qui mérite d&apos;être parfaite.
          </p>
          <div
            style={{
              marginTop: 26,
