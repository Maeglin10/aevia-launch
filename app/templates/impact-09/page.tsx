...
export default function AstrumReachPremium() {
  ...
  useEffect(() => {
    ...
    let n = 3;
    const _photoArrays: any[] = [MISSIONS];
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-8 md:px-12 py-8 border-b border-white/5 bg-black/40 backdrop-blur-xl">
         <div onClick={() => goTo("home")} className="flex flex-col group cursor-pointer">
            {fd?.logoBase64 ? (
              ...
              <span className="text-3xl font-black tracking-[-0.05em] uppercase leading-none group-hover:text-indigo-400 transition-colors">{clientName(sessionData)}</span>
            ) : (<>
              <>
        ...
        {page === "home" && (
          <>
            ...
            <section id="hero" className="relative min-h-dvh flex flex-col justify-center items-center px-6 md:px-12 pt-24 md:pt-32 overflow-hidden">
               ...
               >
                  <img 
                     src={photo(3, "https://images.pexels.com/photos/7327336/pexels-photo-7327336.jpeg?auto=compress&cs=tinysrgb&w=1600")}
         ...
         <div className="max-w-7xl mx-auto">
            ...
            <div className="pt-24 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12 text-[10px] font-black uppercase tracking-[0.5em] text-white/10 italic">
               <div className="flex flex-wrap gap-8 font-mono">
                  <span>©2026 {clientName(sessionData) ?? "ASTRUM REACH ORBITAL."}{/* VILLE_PIED */}{clientCity(sessionData) ? ` · ${clientCity(sessionData)}` : ""}</span>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border border-white/5 bg-black p-12 flex flex-col lg:flex-row items-center gap-12 font-mono">
          <div className="w-full lg:w-1/2 aspect-video relative">
            <img src={photo(4, "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80")} alt="Telemetry HUD" className="w-full h-full object-cover grayscale" />
