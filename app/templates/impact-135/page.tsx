  ...
  return (
    <div style={{ background: C.bg, fontFamily: FONT, overflowX: "hidden" }}>
      ...
      <motion.nav style={{
        ...
        <div id="mb135-nav" style={{ display: "flex", gap: 32, alignItems: "center" }}>      {["Prestations", "Réalisations", "Technique", "Contact"].map(l => (
      ...
      <style>{`@media (max-width: 900px) { #mb135-nav { display: none !important; } .mb135-burger { display: flex !important; } }`}</style>
