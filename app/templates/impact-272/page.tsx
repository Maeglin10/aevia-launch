...
let C: Record<string, string> = {
  ...
  bgDarkAlt: '#040c18',
  bgCard: '#ffffff',
  accent: 'var(--brand,#2878c0)',
  accentDark: 'var(--brand-light,#1c60a0)',
  accentLight: '#bcd8f4',
  white: '#ffffff',
  ink: '#081428',
  textMuted: '#1c3a58',
      ...
      <div
        style={{
          ...
          background:
            ...
            'linear-gradient(to bottom, rgba(8,20,40,0.70) 0%, rgba(8,20,40,0.66) 36%, rgba(8,20,40,0.72) 68%, rgba(8,20,40,0.93) 100%)',
        }}
      />
      <div
        style={{
...
function CareCards() {
  const CARE_CARDS = resolveList(
    clientServices(sessionData)?.map((s: any, i: number) => ({
      title: s.title ?? s.name,
      icon: CARE_CARDS_DEMO[i % CARE_CARDS_DEMO.length].icon,
    })),
    CARE_CARDS_DEMO
  );
  return (
