    ...
    return (
      <section className="py-20 px-6 bg-white border-t border-gray-100 min-h-[70vh]">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-20 h-20 bg-[#7C3AED]/10 rounded-2xl flex items-center justify-center mx-auto mb-8">
            <Users className="w-10 h-10 text-[#7C3AED]" />
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6">La Communauté {clientName(sessionData) ?? "EduPath"}</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left mb-16">
            ...
            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 hover:shadow-lg transition-all">
              ...
              <button className="bg-[#7C3AED] text-white px-6 py-3 rounded-xl font-semibold hover:bg-[#6D28D9] transition-colors">
                Voir l'agenda
              </button>
            </div>
          </div>
...
// @ts-ignore
            <Link href="/templates/impact-11/cours" className={`hover:text-[#7C3AED] transition-colors cursor-pointer ${"communaute" === "cours" ? "text-[#7C3AED] font-bold" : ""}`}>Cours</Link>
// @ts-ignore
            <Link href="/templates/impact-11/mentoring" className={`hover:text-[#7C3AED] transition-colors cursor-pointer ${"communaute" === "mentoring" ? "text-[#7C3AED] font-bold" : ""}`}>Mentoring</Link>
// @ts-ignore
            <Link href="/templates/impact-11/tarifs" className={`hover:text-[#7C3AED] transition-colors cursor-pointer ${"communaute" === "tarifs" ? "text-[#7C3AED] font-bold" : ""}`}>Tarifs</Link>
          </div>
...
// @ts-ignore
                  <Link href="/templates/impact-11/cours" className={`text-xl hover:text-[#7C3AED] transition-colors ${"communaute" === "cours" ? "text-[#7C3AED] font-bold" : "text-gray-600"}`}>Cours</Link>
// @ts-ignore
                  <Link href="/templates/impact-11/mentoring" className={`text-xl hover:text-[#7C3AED] transition-colors ${"communaute" === "mentoring" ? "text-[#7C3AED] font-bold" : "text-gray-600"}`}>Mentoring</Link>
// @ts-ignore
                  <Link href="/templates/impact-11/tarifs" className={`text-xl hover:text-[#7C3AED] transition-colors ${"communaute" === "tarifs" ? "text-[#7C3AED] font-bold" : "text-gray-600"}`}>Tarifs</Link>
// @ts-ignore
                  <Link href="/templates/impact-11/legal" className={`text-xl hover:text-[#7C3AED] transition-colors ${"communaute" === "legal" ? "text-[#7C3AED] font-bold" : "text-gray-600"}`}>Mentions Légales</Link>
               </div>
            </SheetContent>
         </Sheet>
        </div>
