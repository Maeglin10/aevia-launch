...
export default function Page() {
  ...
  const PageContent = () => {
    const BLOG_POSTS = [
      {
        title: "Les 5 compétences tech les plus recherchées en 2026",
        category: "Carrière",
        date: "12 Juin 2026",
        readTime: "5 min",
        excerpt: "Découvrez les technologies qui dominent le marché de l'emploi cette année et comment vous y former rapidement."
      },
      {
        title: "Pourquoi l'IA générative transforme le design UX",
        category: "Design",
        date: "08 Juin 2026",
        readTime: "7 min",
        excerpt: "L'intelligence artificielle ne remplace pas les designers, elle décuple leurs capacités. Analyse d'une révolution en cours."
      },
      {
        title: "Devenir Data Scientist sans diplôme en mathématiques",
        category: "Data",
        date: "25 Mai 2026",
        readTime: "6 min",
        excerpt: "Est-il vraiment nécessaire d'avoir un Master en statistiques pour réussir dans la Data ? Témoignages et conseils."
      }
    ]
