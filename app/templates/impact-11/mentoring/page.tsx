      ...
      <section className="py-20 px-6 bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-[#5b48c9] text-sm font-semibold mb-3 uppercase tracking-wider block">Accompagnement</span>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-24">
            {[
              ...
              <div key={i} className="border border-gray-100 rounded-3xl p-8 bg-gray-50 hover:bg-white hover:shadow-xl transition-all duration-300">
                <div className="w-10 h-10 bg-[#5b48c9]/10 rounded-xl flex items-center justify-center text-[#5b48c9] mb-6 font-bold">{i + 1}</div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {INSTRUCTORS.map((inst, i) => (
                <div key={inst.name} className="border border-gray-100 rounded-3xl p-8 bg-white hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
                  <div>
                    <div className="w-16 h-16 bg-gradient-to-br from-[#5b48c9] to-[#0EA5E9] rounded-2xl mb-6 flex items-center justify-center text-white text-2xl font-bold">
                      {inst.name.charAt(4)}
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-1">{inst.name}</h3>
                    <p className="text-[#5b48c9] text-xs font-semibold mb-4 uppercase tracking-wider">{inst.specialty}</p>
...
// @ts-ignore
            <Link href="/templates/impact-11/cours" className={`hover:text-[#5b48c9] transition-colors cursor-pointer ${"mentoring" === "cours" ? "text-[#5b48c9] font-bold" : ""}`}>Cours</Link>
// @ts-ignore
            <Link href="/templates/impact-11/mentoring" className={`hover:text-[#5b48c9] transition-colors cursor-pointer ${"mentoring" === "mentoring" ? "text-[#5b48c9] font-bold" : ""}`}>Mentoring</Link>
// @ts-ignore
            <Link href="/templates/impact-11/tarifs" className={`hover:text-[#5b48c9] transition-colors cursor-pointer ${"mentoring" === "tarifs" ? "text-[#5b48c9] font-bold" : ""}`}>Tarifs</Link>
          </div>
...
// @ts-ignore
                  <Link href="/templates/impact-11/cours" className={`text-xl hover:text-[#5b48c9] transition-colors ${"mentoring" === "cours" ? "text-[#5b48c9] font-bold" : "text-gray-600"}`}>Cours</Link>
// @ts-ignore
                  <Link href="/templates/impact-11/mentoring" className={`text-xl hover:text-[#5b48c9] transition-colors ${"mentoring" === "mentoring" ? "text-[#5b48c9] font-bold" : "text-gray-600"}`}>Mentoring</Link>
// @ts-ignore
                  <Link href="/templates/impact-11/tarifs" className={`text-xl hover:text-[#5b48c9] transition-colors ${"mentoring" === "tarifs" ? "text-[#5b48c9] font-bold" : "text-gray-600"}`}>Tarifs</Link>
// @ts-ignore
                  <Link href="/templates/impact-11/legal" className={`text-xl hover:text-[#5b48c9] transition-colors ${"mentoring" === "legal" ? "text-[#5b48c9] font-bold" : "text-gray-600"}`}>Mentions Légales</Link>
               </div>
            </SheetContent>
         </Sheet>
        </div>
