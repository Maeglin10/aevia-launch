        ...
        <div className="i361-card">
          <WipeReveal index={i}>
            <div style={{ background: C.white, border: `1px solid ${C.border}`, borderRadius: 10, overflow: "hidden", boxShadow: "0 18px 52px rgba(0,0,0,0.18)" }}>
              <div style={{ aspectRatio: "4/3", display: "flex", alignItems: "center", justifyContent: "center", background: C.accentLight }}><Palette size={64} color={C.accentDark} strokeWidth={1.2} /></div>
