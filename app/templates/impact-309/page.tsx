                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? fd?.phone ?? "+33579448021").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientPhone(sessionData) ?? fd?.phone ?? "+33 (0)5 00 00 00 00"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientEmail(sessionData) ?? fd?.email ?? "contact@encredélicate.com"}</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 15, color: C.text, fontWeight: 700 }}>
                        {clientCity(sessionData) ?? "tatouage fineline Bordeaux"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  {formSubmitted ? (
                    ...
                    >
                      ...
                      <h3 style={{ fontFamily: SERIF, fontSize: 22, color: C.primaryDark, marginBottom: 8, fontWeight: 700 }}>Demande de rendez-vous reçue !</h3>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <h4 style={{ fontFamily: SERIF, fontSize: 18, color: C.primaryDark, marginBottom: 16, fontWeight: 700 }}>{fd?.businessName ?? "Encre Délicate"}</h4>
