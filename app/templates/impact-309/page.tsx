...
export default function Page() {
  ...
  const menuItemsFiltered = activeCategory === "Tous"
    ? [{"name": "Tatouage Fineline Poignet", "category": "Fineline", "desc": "Motif floral délicat tracé avec des aiguilles ultra-fines.", "price": "120,00 €"}, {"name": "Projet Aquarelle Dos", "category": "Aquarelle", "desc": "Composition colorée à effet aquarelle fluide et fondue.", "price": "250,00 €"}, {"name": "Mini Flash Lettrage", "category": "Minimaliste", "desc": "Mot ou date symbolique, typographie fine sur mesure.", "price": "80,00 €"}]
    : [{"name": "Tatouage Fineline Poignet", "category": "Fineline", "desc": "Motif floral délicat tracé avec des aiguilles ultra-fines.", "price": "120,00 €"}, {"name": "Projet Aquarelle Dos", "category": "Aquarelle", "desc": "Composition colorée à effet aquarelle fluide et fondue.", "price": "250,00 €"}, {"name": "Mini Flash Lettrage", "category": "Minimaliste", "desc": "Mot ou date symbolique, typographie fine sur mesure.", "price": "80,00 €"}].filter(item => item.category === activeCategory);
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          ...
          }}>{fd?.businessName ?? "Encre Délicate"}</a>
      ...
      <section id="faq" style={{ padding: '120px 24px', background: C.bgDeep }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[{"q":"Quelles sont les consignes d'hygiène ?","a":"Nous utilisons exclusivement du matériel à usage unique stérile ouvert devant vous, et notre studio respecte les protocoles de stérilisation de classe médicale."},{"q":"Est-ce douloureux le tatouage fineline ?","a":"Le tracé fin utilise des aiguilles beaucoup plus fines que le tatouage classique, ce qui réduit significativement la sensation de douleur et facilite la cicatrisation."},{"q":"Comment réserver une séance ?","a":"Remplissez le formulaire de contact en détaillant votre idée, la taille souhaitée et l'emplacement sur le corps. Nous vous répondrons sous 5 jours."}].map((item, i) => (
