...
let C: Record<string, string> = {
  primary: "var(--brand,#6b3fa0)",
  primaryLight: "var(--brand-light,#8b5cc0)",
  primaryDark: "#4e2d78",
  bg: "#fafaf8",
  bgDeep: "#f4f3f0",
  bgCard: "#ffffff",
...
const SERIF = "'Spectral', serif" as const;
const SANS = "'Mulish', sans-serif" as const;

const EASE: [number, number, number, number] = [0.16, 1, 0.3, 1];

const PHOTO = {
  hero: "https://images.unsplash.com/photo-1622253692010-333f2da6031d?q=80&w=1600&auto=format&fit=crop",
  about: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=1600&auto=format&fit=crop",
  special: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=1600&auto=format&fit=crop",
  gallery1: "https://images.unsplash.com/photo-1486825586573-7131f7991bdd?q=80&w=800&auto=format&fit=crop",
  gallery2: "https://images.unsplash.com/photo-1516549655169-df83a0774514?q=80&w=800&auto=format&fit=crop",
  gallery3: "https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?q=80&w=800&auto=format&fit=crop",
  gallery4: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=800&auto=format&fit=crop"
} as const;
    ...
    <div style={{
        ...
        <div style={{
          ...
          <a href="#hero" style={{
            ...
            {fd?.logoBase64 ? (
              ...
              (clientName(sessionData) ?? (clientName(sessionData) ?? "Dr. Camille Faure"))
            )}
          </a>
      ...
      >
        <motion.div style={{
          ...
          <img 
            src={PHOTO.hero} 
            alt="Hero image showing Dr. Camille Faure core business" 
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "15 min", "label": "Temps Moyen d'Attente"}, {"value": "100%", "label": "Suivi Personnalisé"}, {"value": "24/48h", "label": "Rendez-vous Rapide"}].map((stat, i) => (
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Bilan de condition physique, suivi d'athlètes amateurs et professionnels, certificats sportifs.
            </p>
          </Reveal>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{fd?.email ?? "contact@dr.camillefaure.com"}</a>
                    </div>
                  </div>
