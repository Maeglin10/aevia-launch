        ...
        <div style={{
          ...
          <a href="#hero" style={{
            ...
            {fd?.logoBase64 ? (
              ...
              (clientName(sessionData) ?? "Dr. Camille Faure")
            )}
          </a>
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{clientName(sessionData) ?? (clientName(sessionData) ?? "Dr. Camille Faure")}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            © {new Date().getFullYear()} Dr. Camille Faure. Tous droits réservés.
          </div>
        </div>
      </footer>
