        ...
        <div className="max-w-[800px] mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic mb-12">
              Residential <br />
              <span className="not-italic font-thin text-white">Estates.</span>
            </h1>
            
            <div className="space-y-8 text-white/60 font-light italic leading-relaxed">
              <p>
                Exclusive access to off-market ultra-luxury real estate.
              </p>
              <p>
                Our portfolio encompasses the most sought-after properties globally, from alpine retreats to metropolitan penthouses.
              </p>
            </div>
          </motion.div>
        </div>
