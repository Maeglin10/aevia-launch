        ...
        <div className="max-w-[800px] mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic mb-12">
              Private <br />
              <span className="not-italic font-thin text-white">Aviation.</span>
            </h1>
            
            <div className="space-y-8 text-white/60 font-light italic leading-relaxed">
              <p>
                Seamless global transit.
              </p>
              <p>
                Unrestricted access to an elite fleet of private jets, ensuring optimal routing, absolute privacy, and unparalleled inflight service.
              </p>
            </div>
          </motion.div>
        </div>
