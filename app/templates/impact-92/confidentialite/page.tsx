        ...
        <div className="max-w-[800px] mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic mb-12">
              Privacy <br />
              <span className="not-italic font-thin text-white">Policy.</span>
            </h1>
            ...
            <div className="space-y-8 text-white/60 font-light italic leading-relaxed">
              ...
              <p>
                We employ military-grade encryption and ISO 27001 compliant protocols to ensure complete client confidentiality.
              </p>
            </div>
          </motion.div>
        </div>
