        ...
        <div className="max-w-[800px] mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic mb-12">
              Global <br />
              <span className="not-italic font-thin text-white">Security.</span>
            </h1>
            
            <div className="space-y-8 text-white/60 font-light italic leading-relaxed">
              <p>
                Une protection discrète et absolue.
              </p>
              <p>
                Sécurité opérationnelle conforme ISO 27001, protection rapprochée et coordination de déplacements sécurisés dans le monde entier.
              </p>
            </div>
          </motion.div>
        </div>
