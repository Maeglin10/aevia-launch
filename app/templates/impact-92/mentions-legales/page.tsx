        ...
        <div className="max-w-[800px] mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic mb-12">
              Mentions <br />
              <span className="not-italic font-thin text-white">Légales.</span>
            </h1>
            ...
            <div className="space-y-8 text-white/60 font-light italic leading-relaxed">
              ...
              <p>
                Skyline Concierge Group operates under strict regulatory compliance and absolute discretion in all jurisdictions.
              </p>
            </div>
          </motion.div>
        </div>
