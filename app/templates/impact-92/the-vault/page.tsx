        ...
        <div className="max-w-[800px] mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic mb-12">
              The <br />
              <span className="not-italic font-thin text-white">Vault.</span>
            </h1>
            ...
            <div className="space-y-8 text-white/60 font-light italic leading-relaxed">
              ...
              <p>
                State-of-the-art physical and digital storage solutions for high-value assets, ensuring complete confidentiality and protection.
              </p>
            </div>
          </motion.div>
        </div>
