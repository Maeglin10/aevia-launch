        ...
        <div className="max-w-[800px] mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic mb-12">
              Exclusive <br />
              <span className="not-italic font-thin text-white">Membership.</span>
            </h1>
            ...
            <div className="space-y-8 text-white/60 font-light italic leading-relaxed">
              ...
              <p>
                Skyline Concierge Group operates strictly by referral or private application, curating a membership of the world's most discerning individuals.
              </p>
            </div>
          </motion.div>
        </div>
