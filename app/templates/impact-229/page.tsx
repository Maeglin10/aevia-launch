...
export default function EclatSpaPage() {
  ...
  return (
    <div style={{ background: C.bg, fontFamily: FONT_BODY, overflowX: "hidden" }}>
      ...
      <style>{`
        @media (max-width: 900px) { #mb229-nav { display: none !important; } .mb229-burger { display: flex !important; } }
        @media (max-width: 640px) {
          #hero { height: 100dvh !important; min-height: 100dvh !important; }
          .mb229-hero-text { padding: 0 24px 40px !important; }
        }
      `}</style>
      ...
      <section style={{ padding: "100px 80px", background: C.bgSection }}>
        <div className="imx-mobstack" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          ...
          <Reveal><img src={photo(1, (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=800&q=80"))} alt="Soin visage naturel" style={{ width: "100%", borderRadius: 16, aspectRatio: "4/3", objectFit: "cover" }} /></Reveal>
        </div>
      </section>
