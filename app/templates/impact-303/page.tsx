...
const SERIF = "'Poppins', sans-serif" as const;
...
function PHOTO_LIVE() {
  ...
  about: (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1518310383802-640c2de311b2?q=80&w=1600&auto=format&fit=crop"),
  special: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1490645935967-10de6ba17061?q=80&w=1600&auto=format&fit=crop"),
  gallery1: (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=800&auto=format&fit=crop"),
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?q=80&w=800&auto=format&fit=crop"),
  gallery3: (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=800&auto=format&fit=crop"),
  gallery4: (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1505576399279-565b52d4ac71?q=80&w=800&auto=format&fit=crop")
} as const;
}
    ...
    <div style={{
      ...
      >
        <motion.div style={{
          ...
          <img 
            src={PHOTO.hero} 
            alt="Hero image showing Studio Peak Performance core business" 
        ...
        <div style={{
          ...
          <Reveal delay={0.55}>
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="#contact" style={{ textDecoration: 'none' }}>
                <Button filled>Démarrer ma transformation</Button>
              </a>
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "12 sem", "label": "Transformation"}, {"value": "24/7", "label": "Support Coach"}, {"value": "100%", "label": "Garantis"}].map((stat, i) => (
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{clientName(sessionData) ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Studio Peak Performance"))}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Suivi de vos entraînements, recettes personnalisées, communication directe avec votre coach. iOS & Android.
            </p>
          </Reveal>
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <Reveal delay={0.15}>
              <div style={{
                ...
                {["Tous","Coaching","Suivi","Forfaits"].map((tab, i) => (
                  <button
                    key={i}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>{clientEmail(sessionData) ?? fd?.email ?? "contact@studiopeakperformance.com"}</a>
                    </div>
                  </div>
                ...
                <div style={{
                  ...
                  {formSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      ...
                      <Button type="submit" filled>Démarrer ma transformation</Button>
                    </form>
                  )}
                </div>
              </Reveal>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                Coaching 7j/7 · Réponse garantie en 2h
              </p>
            </div>
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6, fontSize: 12 }}>
                ...
                Responsable de publication: Studio Peak Performance<br />
