            ...
            <div className="font-sans">
              ...
              <div className="space-y-8 mb-12">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-700 text-sm leading-relaxed">
                      Adresse communiquée sur demande à <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@exemple.fr"}`} className="text-[#2D1B0E] underline underline-offset-2">{clientEmail(sessionData) ?? fd?.email ?? "contact@exemple.fr"}</a>.<br />
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@exemple.fr"}`} className="text-[#2D1B0E] text-sm hover:text-[#C4A265] transition-colors">
              ...
              <div className="bg-[#2D1B0E]/5 border border-[#2D1B0E]/10 p-6">
                ...
                <p className="text-sm text-zinc-600 font-sans leading-relaxed">
                  Pour les commandes professionnelles (négoce, restauration, grandes surfaces spécialisées), contactez notre service caveau directement à <a href={`mailto:${clientEmail(sessionData) ?? fd?.email ?? "contact@exemple.fr"}`} className="text-[#2D1B0E] underline underline-offset-2">{clientEmail(sessionData) ?? fd?.email ?? "contact@exemple.fr"}</a>.
                </p>
              </div>
            </div>
          </Reveal>
