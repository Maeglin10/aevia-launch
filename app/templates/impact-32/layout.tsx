      ...
      <footer style={{ background: C.text, color: C.white, padding: "70px 80px 32px", fontFamily: FONT }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 48, marginBottom: 52 }}>
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
              {[
                { icon: <Mail size={15} />, text: (clientEmail(__layoutSession) ?? fd?.email ?? "contact@pawcare-bordeaux.fr") },
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <p style={{ color: "rgba(255,255,255,0.38)", fontSize: 14 }}>
            © 2026 {/* NOM_PIED */ clientName(__layoutSession) ?? "PawCare Clinic"} — Site réalisé par <Link href="/templates/impact-32/legal" style={{ color: "rgba(255,255,255,0.38)", textDecoration: "none" }}>Aevia WS</Link>
          </p>
