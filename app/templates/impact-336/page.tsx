...
const ENGAGEMENT = ["Inscrite à l'Ordre national des pharmaciens — licence n° 25#002214", "Un pharmacien diplômé d'État présent à chaque heure d'ouverture", "Tiers payant carte Vitale + mutuelle : aucune avance de frais", "Secret professionnel au comptoir : un espace de confidentialité dédié"];
...
const STATS = [{"value": "2 h", "label": "Ordonnance préparée"}, {"value": "6 j/7", "label": "Sans interruption"}, {"value": "0 €", "label": "D'avance de frais"}, {"value": "5", "label": "Pharmaciens diplômés"}];
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
          {fd?.logoBase64 ? (
            ...
            <>
              ...
              <span style={{ fontFamily: FONT, fontSize: 18, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{fd?.businessName ?? "Pharmacie de l'Horloge"}</span>
      ...
      <footer className="i336-pad" style={{ background: C.bgDark, padding: "44px 64px 22px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 28, marginBottom: 30 }}>
            <div>
              <div style={{ fontFamily: FONT, fontSize: 18, color: C.hi, marginBottom: 8 }}>{fd?.businessName ?? "Pharmacie de l'Horloge"}</div>
              <p style={{ color: "rgba(255,255,255,0.38)", fontSize: 13, lineHeight: 1.7 }}>Pharmacie d'officine · Besançon<br />Ordre national des pharmaciens — licence n° 25#002214</p>
            </div>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.09)", paddingTop: 14, display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 12 }}>
              © 2026 {fd?.businessName ?? "Pharmacie de l'Horloge"} — Site réalisé par Aevia WS · SIREN <LegalIdentity />
            </span>
