...
export const attorneys = [
  {
    ...
    bar: clientCityOr("Paris") + " Bar, 1998",
    education: "Sciences Po " + clientCityOr("Paris") + ", Harvard Law LLM",
  ...
  },
  {
    name: "Claire Vernet",
    title: "Partner",
    bar: clientCityOr("Paris") + " Bar, 2004",
    education: "Université " + clientCityOr("Paris") + " I, NYU School of Law LLM",
  ...
  },
  {
    ...
    title: "Partner",
    bar: clientCityOr("Paris") + " Bar, 2007",
    education: "Université " + clientCityOr("Paris") + " II, Columbia Law LLM",
    focus: "Commercial Litigation, Arbitration",
    bio: "Marc-Antoine is one of " + clientCityOr("Paris") + "'s leading commercial litigators, with an exceptional record in ICC arbitration and French commercial court proceedings. He handles the firm's most complex adversarial matters.",
    matters: "200+ cases",
    value: "€1.1B+",
