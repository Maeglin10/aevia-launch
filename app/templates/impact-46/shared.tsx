...
export const attorneys = [
  {
    ...
    get bar() { return clientCityOr("Paris") + " Bar, 1998"; },
    get education() { return "Sciences Po " + clientCityOr("Paris") + ", Harvard Law LLM"; },
  ...
  },
  {
    name: "Claire Vernet",
    title: "Partner",
    get bar() { return clientCityOr("Paris") + " Bar, 2004"; },
    get education() { return "Université " + clientCityOr("Paris") + " I, NYU School of Law LLM"; },
  ...
  },
  {
    ...
    title: "Partner",
    get bar() { return clientCityOr("Paris") + " Bar, 2007"; },
    get education() { return "Université " + clientCityOr("Paris") + " II, Columbia Law LLM"; },
