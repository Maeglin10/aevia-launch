...
let C: Record<string, string> = {
  primary: "var(--brand,#6b7c45)",
  primaryLight: "var(--brand-light,#8a9e5a)",
  primaryDark: "#4e5c30",
  bg: "#faf9f5",
  bgDeep: "#f2f0e8",
  bgCard: "#ffffff",
...
const SERIF = "'Fraunces', serif" as const;
...
function PHOTO_LIVE() {
  return {
  hero: (clientPhotos(sessionData)[0] || "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?q=80&w=1600&auto=format&fit=crop"),
  about: (clientPhotos(sessionData)[1] || "https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=1600&auto=format&fit=crop"),
  special: (clientPhotos(sessionData)[2] || "https://images.unsplash.com/photo-1599599810769-bcde5a160d32?q=80&w=1600&auto=format&fit=crop"),
  gallery1: (clientPhotos(sessionData)[3] || "https://images.unsplash.com/photo-1600585154526-990dced4db0d?q=80&w=800&auto=format&fit=crop"),
  gallery2: (clientPhotos(sessionData)[4] || "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?q=80&w=800&auto=format&fit=crop"),
  gallery3: (clientPhotos(sessionData)[5] || "https://images.unsplash.com/photo-1508849789987-4e5333c12b78?q=80&w=800&auto=format&fit=crop"),
  gallery4: (clientPhotos(sessionData)[6] || "https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=800&auto=format&fit=crop")
} as const;
}
    ...
    <div style={{
        ...
        <div style={{
          ...
          <a href="#hero" style={{
            ...
            {fd?.logoBase64 ? (
              ...
              fd?.businessName ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Jardins de l'Hérault"))
            )}
          </a>
      ...
      >
        <motion.div style={{
          ...
          <img 
            src={PHOTO.hero} 
            alt="Hero image showing Jardins de l'Hérault core business" 
      ...
      <section style={{ padding: '80px 24px', background: C.bgDeep, borderBottom: `1px solid ${C.primary}0d` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            {menuItemsFiltered.length > 0 && [{"value": "-70%", "label": "Consommation Eau"}, {"value": "100%", "label": "Espèces Locales"}, {"value": "RGE", "label": "Techniques Durables"}].map((stat, i) => (
      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>{fd?.businessName ?? (clientName(sessionData) ?? (clientName(sessionData) ?? "Jardins de l'Hérault"))}</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <Reveal>
            ...
            <p style={{
              ...
              Conception avec des espèces endémiques : olivier, figuier, garrigue, lavande. Arrosage réduit de 70% vs pelouse traditionnelle.
            </p>
          </Reveal>
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <Reveal delay={0.15}>
              <div style={{
                ...
                {["Tous","Création","Irrigation","Entretien"].map((tab, i) => (
                  <button
                    key={i}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`tel:${(clientPhone(sessionData) ?? clientEmail(sessionData) ?? fd?.email ?? "+33571685683").replace(/[^+0-9]/g, "")}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>+33 (0)5 00 00 00 00</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href={`mailto:${fd?.email ?? "contact@mysite.com"}`} style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>contact@jardinsdel'hérault.com</a>
                    </div>
                  </div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6 }}>
                Lun–Ven 8h–18h · Sam matin sur RDV
              </p>
            </div>
