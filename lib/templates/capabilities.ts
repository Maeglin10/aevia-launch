...
export const THEME_BLOCKS: Record<string, ContentBlock[]> = {
  ...
  "impact-27": ["avis", "chiffres", "engagements", "equipe", "faq", "prestations", "tarifs"],
  ...
  "impact-57": ["avis", "methode", "prestations", "engagements"],
  ...
  "impact-209": ["avis", "chiffres", "equipe", "prestations", "realisations", "tarifs"],
  ...
  "impact-220": ["avis", "chiffres", "prestations", "realisations"],
