...
export const THEME_BLOCKS: Record<string, ContentBlock[]> = {
  ...
  "impact-29": ["avis", "chiffres", "methode", "realisations"],
  ...
  "impact-45": ["chiffres", "realisations", "tarifs"],
  ...
  "impact-108": ["chiffres", "horaires"],
  "impact-109": ["avis", "equipe", "produits"],
  ...
  "impact-169": ["avis", "chiffres", "faq", "tarifs"],
