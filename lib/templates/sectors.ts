...
export const SECTOR_TEMPLATES: Record<string, string[]> = {
  ...
  tatoueur:            ['impact-249', 'impact-262', 'impact-267', 'impact-270', 'impact-309', 'impact-199', 'impact-226', 'impact-124', "impact-45"],
  paysagiste:          ['impact-250', 'impact-263', 'impact-268', 'impact-271', 'impact-310', 'impact-232', "impact-359", "impact-14", "impact-39"],
